...
import {CoreModuleDataCommentDtoModel,
  CoreModuleDataCommentModel,
  ErrorExceptionResult,
  ErrorExceptionResultBase,IApiCmsServerBase,
...
export class CmsDataCommentComponent implements OnInit {
  ...
  dataModelResult: ErrorExceptionResult<CoreModuleDataCommentModel> =
  ...
  dataModel: CoreModuleDataCommentDtoModel =
    new CoreModuleDataCommentDtoModel();
  ...
  DataGetAll(): void {
    ...
    if (
      ...
      this.service
        .ServiceCommentGetAllEntity(this.dataModel.moduleEntityId)
        .subscribe({
          next: (ret) => {
