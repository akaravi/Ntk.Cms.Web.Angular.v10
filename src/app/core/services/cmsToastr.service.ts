...
export class CmsToastrService {
  ...
  typeOrderActionLogout(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeOrderActionLogout",
        "ERRORMESSAGE.TITLE.typeOrderActionLogout",
      ])
  ...
  typeSuccessAccessChange(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessAccessChange",
        "ERRORMESSAGE.TITLE.typeSuccessAccessChange",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], this.now() + str[1]);
      });
  ...
  typeSuccessAddFirstSite(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessAddFirstSite",
        "ERRORMESSAGE.TITLE.typeSuccessAddFirstSite",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], this.now() + str[1]);
      });
  ...
  typeSuccessCopedToClipboard(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessCopedToClipboard",
  ...
  typeSuccessSend(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessSend",
        "ERRORMESSAGE.TITLE.typeSuccessSend",
      ])
      .subscribe((str: string[]) => {
  ...
  typeSuccessAddSimilar(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessAddSimilar",
        "ERRORMESSAGE.TITLE.typeSuccessAddSimilar",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessAddOtherInfo(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessAddOtherInfo",
        "ERRORMESSAGE.TITLE.typeSuccessAddOtherInfo",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessAddTag(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessAddTag",
        "ERRORMESSAGE.TITLE.typeSuccessAddTag",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessRemoveTag(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessRemoveTag",
        "ERRORMESSAGE.TITLE.typeSuccessRemoveTag",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessSetStatus(strMessage: string): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessSetStatus",
  ...
  typeSuccessRemoveOtherInfo(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessRemoveOtherInfo",
        "ERRORMESSAGE.TITLE.typeSuccessRemoveOtherInfo",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessRemoveSimilar(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessRemoveSimilar",
        "ERRORMESSAGE.TITLE.typeSuccessRemoveSimilar",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessRemove(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessRemove",
        "ERRORMESSAGE.TITLE.typeSuccessRemove",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessEdit(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessEdit",
        "ERRORMESSAGE.TITLE.typeSuccessEdit",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessChangePassword(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessChangePassword",
        "ERRORMESSAGE.TITLE.typeSuccessChangePassword",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessMove(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessMove",
        "ERRORMESSAGE.TITLE.typeSuccessMove",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessLogin(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessLogin",
        "ERRORMESSAGE.TITLE.typeSuccessLogin",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessLogout(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessLogout",
        "ERRORMESSAGE.TITLE.typeSuccessLogout",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessEmailConfirm(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessEmailConfirm",
        "ERRORMESSAGE.TITLE.typeSuccessEmailConfirm",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessMobileConfirm(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessMobileConfirm",
        "ERRORMESSAGE.TITLE.typeSuccessMobileConfirm",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessRegistery(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessRegistery",
        "ERRORMESSAGE.TITLE.typeSuccessRegistery",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessSelected(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessSelected",
        "ERRORMESSAGE.TITLE.typeSuccessSelected",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeSuccessAppBuild(strMessage: string): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessAppBuild",
  ...
  typeSuccessAppUpload(): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeSuccessAppUpload",
        "ERRORMESSAGE.TITLE.typeSuccessAppUpload",
      ])
      .subscribe((str: string[]) => {
        this.toastr.success(str[0], str[1]);
      });
  ...
  typeErrorInternetConnection(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorInternetConnection",
  ...
  typeErrorUserToken(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorUserToken",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorAccessChange(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorAccessChange",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorDeviceToken(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorDeviceToken",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorComponentAction(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorComponentAction",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorFormInvalid(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorFormInvalid",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorGetAccess(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorGetAccess",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorAccessAdd(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorAccessAdd",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorAccessWatch(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorAccessWatch",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorAccessEdit(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorAccessEdit",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorAccessDelete(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorAccessDelete",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorGetOne(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorGetOne",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorSetStatus(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorSetStatus",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorGetAll(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorGetAll",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorAddSimilar(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorAddSimilar",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorAddOtherInfo(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorAddOtherInfo",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorAddTag(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorAddTag",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorRemoveTag(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorRemoveTag",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorRemoveOtherInfo(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorRemoveOtherInfo",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorRemoveSimilar(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorRemoveSimilar",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorGetCpatcha(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorGetCpatcha",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorAddDuplicate(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorAddDuplicate",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorRemove(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorRemove",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorEdit(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorEdit",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorMove(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorMove",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorLogin(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorLogin",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorEditRowIsNull(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorEditRowIsNull",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorDeleteRowIsNull(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorDeleteRowIsNull",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorAddRowParentIsNull(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorAddRowParentIsNull",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorLogout(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorLogout",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorRegistery(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorRegistery",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeErrorSelected(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorSelected",
        "ERRORMESSAGE.TITLE.Error",
  ...
  typeError(model: any, strMessage: string = ""): void {
    ...
    if (!model || model == undefined || model == null) {
      this.translate
        .get(["ERRORMESSAGE.MESSAGE.typeError", strTitle])
        .subscribe((str: string[]) => {
    ...
    if (model.error) {
      ...
      if (errorExceptionResult) {
        if (errorExceptionResult.status === 401) {
          this.translate
            .get(["ERRORMESSAGE.MESSAGE.typeError_login", strTitle])
            .subscribe((str: string[]) => {
              let message = str[0] + " " + strMessage;
              this.toastr.error(
                message.replace(/(?:\r\n|\r|\n)/g, "<br>"),
    ...
    if (model.errors) {
      ...
      this.translate
        .get(["ERRORMESSAGE.MESSAGE.typeError_viewConsoleLog", strTitle])
        .subscribe((str: string[]) => {
          let message = str[0] + " " + strMessage;
          this.toastr.error(
            message.replace(/(?:\r\n|\r|\n)/g, "<br>"),
  ...
  typeErrorForNotComplete(strMessage: string = ""): void {
    this.translate
      .get([
        "ERRORMESSAGE.MESSAGE.typeErrorForNotComplete",
        "ERRORMESSAGE.TITLE.Error",
  ...
  // Helper method to validate translation keys
  ...
  private getTranslationWithFallback(
    ...
    this.translate.get(keys).subscribe((translations: any) => {
      const message = translations[keys[0]] || fallbackMessage;
      const title = translations[keys[1]] || "System Message";
      this.toastr.info(message, this.now() + title);
    });
  }
}
