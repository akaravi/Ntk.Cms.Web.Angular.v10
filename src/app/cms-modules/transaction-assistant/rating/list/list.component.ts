...
import { TransactionAssistantRatingAddComponent } from "../add/add.component";
import { TransactionAssistantRatingEditComponent } from "../edit/edit.component";

@Component({
  selector: "app-transaction-assistant-rating-list",
  ...
  implements OnInit, OnDestroy
{
  ...
  onActionButtonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(TransactionAssistantRatingAddComponent, {
      height: "90%",
    ...
    this.translate
      ...
      .subscribe((str: string) => {
        ...
        message =
          ...
          "?" +
          "<br> ( " +
          (this.tableRowSelected.score || this.tableRowSelected.id) +
          " ) ";
      });
