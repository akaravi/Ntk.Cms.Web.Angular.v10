...
import { TransactionAssistantAddressAddComponent } from "../add/add.component";
import { TransactionAssistantAddressEditComponent } from "../edit/edit.component";

@Component({
  selector: "app-transaction-assistant-address-list",
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    public contentService: TransactionAssistantAddressService,
    ...
    this.translate
      ...
      .subscribe((str: string) => {
        ...
        message =
          ...
          "?" +
          "<br> ( " +
          (this.tableRowSelected.city || this.tableRowSelected.id) +
          " ) ";
      });
