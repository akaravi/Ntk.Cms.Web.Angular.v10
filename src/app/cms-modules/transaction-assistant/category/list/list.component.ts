...
import { TransactionAssistantCategoryAddComponent } from "../add/add.component";
import { TransactionAssistantCategoryEditComponent } from "../edit/edit.component";

@Component({
  selector: "app-transaction-assistant-category-list",
  templateUrl: "./list.component.html",
  styleUrls: ["./list.component.scss"],
  standalone: false,
})
export class TransactionAssistantCategoryListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    private contentService: TransactionAssistantProductCategoryService,
  ...
  expandedElement: TransactionAssistantProductCategoryModel | null;
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new TransactionAssistantProductCategoryModel());
  ...
  onActionButtonEditRow(
    model: TransactionAssistantProductCategoryModel = this.tableRowSelected,
  ): void {
    ...
    this.translate
      ...
      .subscribe((str: string) => {
        ...
        message =
          ...
          "?" +
          "<br> ( " +
          (this.tableRowSelected.title || this.tableRowSelected.id) +
          " ) ";
      });
