...
@Component({
  selector: "app-transaction-assistant-category-edit",
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<TransactionAssistantCategoryEditComponent>,
  ...
  DataGetOneContent(): void {
    ...
    this.transactionAssistantProductCategoryService.setAccessLoad();
    this.transactionAssistantProductCategoryService.setAccessDataType(
