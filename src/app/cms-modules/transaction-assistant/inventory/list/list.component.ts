...
import { TransactionAssistantInventoryAddComponent } from "../add/add.component";
import { TransactionAssistantInventoryEditComponent } from "../edit/edit.component";

@Component({
  selector: "app-transaction-assistant-inventory-list",
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    private contentService: TransactionAssistantInventoryService,
