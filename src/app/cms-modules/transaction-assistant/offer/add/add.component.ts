...
@Component({
  selector: "app-transaction-assistant-offer-add",
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<TransactionAssistantOfferAddComponent>,
  ...
  DataAddContent(): void {
    ...
    this.transactionAssistantOfferService.ServiceAdd(this.dataModel).subscribe({
      next: (ret) => {
