...
import { TransactionAssistantOrderAddComponent } from "../add/add.component";
import { TransactionAssistantOrderEditComponent } from "../edit/edit.component";

@Component({
  selector: "app-transaction-assistant-order-list",
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    private contentService: TransactionAssistantOrderService,
  ...
  onActionButtonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(TransactionAssistantOrderAddComponent, {
      height: "90%",
  ...
  onActionButtonEditRow(
    ...
    const dialogRef = this.dialog.open(TransactionAssistantOrderEditComponent, {
      height: "90%",
      panelClass: panelClass,
      enterAnimationDuration: environment.cmsViewConfig.enterAnimationDuration,
      exitAnimationDuration: environment.cmsViewConfig.exitAnimationDuration,
