...
import { TransactionAssistantTagAddComponent } from "../add/add.component";
import { TransactionAssistantTagEditComponent } from "../edit/edit.component";

@Component({
  selector: "app-transaction-assistant-tag-list",
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    private contentService: TransactionAssistantTagService,
  ...
  onActionButtonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(TransactionAssistantTagAddComponent, {
      height: "90%",
  ...
  onActionButtonEditRow(
    ...
    const dialogRef = this.dialog.open(TransactionAssistantTagEditComponent, {
      height: "90%",
      panelClass: panelClass,
      enterAnimationDuration: environment.cmsViewConfig.enterAnimationDuration,
      exitAnimationDuration: environment.cmsViewConfig.exitAnimationDuration,
