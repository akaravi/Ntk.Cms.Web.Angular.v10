...
@Component({
  selector: "app-transaction-assistant-tag-add",
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<TransactionAssistantTagAddComponent>,
  ...
  DataAddContent(): void {
    ...
    this.transactionAssistantTagService.ServiceAdd(this.dataModel).subscribe({
      next: (ret) => {
