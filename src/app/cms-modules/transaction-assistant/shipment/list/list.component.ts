...
import { TransactionAssistantShipmentAddComponent } from "../add/add.component";
import { TransactionAssistantShipmentEditComponent } from "../edit/edit.component";

@Component({
  selector: "app-transaction-assistant-shipment-list",
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    private contentService: TransactionAssistantShipmentService,
    ...
    this.translate
      ...
      .subscribe((str: string) => {
        ...
        message =
          ...
          "?" +
          "<br> ( " +
          (this.tableRowSelected.trackingCode || this.tableRowSelected.id) +
          " ) ";
      });
