...
export class TransactionAssistantShipmentEditComponent
  ...
  implements OnInit
{
  ...
  DataGetOneContent(): void {
    ...
    this.transactionAssistantShipmentService.setAccessLoad();
    this.transactionAssistantShipmentService.setAccessDataType(
      ManageUserAccessDataTypesEnum.Editor,
    );
    this.transactionAssistantShipmentService
        ...
        next: (ret) => {
          ...
          if (ret.isSuccess) {
            this.formInfo.formTitle =
              this.formInfo.formTitle +
              " " +
              (ret.item.trackingCode || ret.item.id);
            this.formInfo.submitResultMessage = "";
