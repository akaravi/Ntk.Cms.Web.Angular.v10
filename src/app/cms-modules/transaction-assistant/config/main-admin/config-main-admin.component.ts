...
@Component({
  selector: "app-transaction-assistant-config-mainadmin",
  templateUrl: "./config-main-admin.component.html",
  standalone: false,
})
export class TransactionAssistantConfigMainAdminComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  constructorInfoAreaId = this.constructor.name;
  constructor(
    private configService: TransactionAssistantConfigurationService,
  ...
  dataConfigSiteValuesDefaultModel = new BaseModuleConfigSiteValuesModel();
  dataConfigSiteAccessValuesDefaultModel =
    new BaseModuleConfigSiteAccessValuesModel();
  dataConfigAdminMainModel = new BaseModuleConfigAdminMainValuesModel();
