...
import { TransactionAssistantCartAddComponent } from "../add/add.component";
import { TransactionAssistantCartEditComponent } from "../edit/edit.component";

@Component({
  selector: "app-transaction-assistant-cart-list",
  ...
  implements OnInit, OnDestroy
{
  ...
  onActionButtonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(TransactionAssistantCartAddComponent, {
      height: "90%",
  ...
  onActionButtonEditRow(
    ...
    const dialogRef = this.dialog.open(TransactionAssistantCartEditComponent, {
      height: "90%",
      panelClass: panelClass,
      enterAnimationDuration: environment.cmsViewConfig.enterAnimationDuration,
      exitAnimationDuration: environment.cmsViewConfig.exitAnimationDuration,
