...
import { TransactionAssistantSupplierAddComponent } from "../add/add.component";
import { TransactionAssistantSupplierEditComponent } from "../edit/edit.component";

@Component({
  selector: "app-transaction-assistant-supplier-list",
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    private contentService: TransactionAssistantSupplierService,
    ...
    this.translate
      ...
      .subscribe((str: string) => {
        ...
        message =
          ...
          "?" +
          "<br> ( " +
          (this.tableRowSelected.name || this.tableRowSelected.id) +
          " ) ";
      });
