...
import { TransactionAssistantInvoiceAddComponent } from "../add/add.component";
import { TransactionAssistantInvoiceEditComponent } from "../edit/edit.component";

@Component({
  selector: "app-transaction-assistant-invoice-list",
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    private contentService: TransactionAssistantInvoiceService,
    ...
    this.translate
      ...
      .subscribe((str: string) => {
        ...
        message =
          ...
          "?" +
          "<br> ( " +
          (this.tableRowSelected.invoiceNumber || this.tableRowSelected.id) +
          " ) ";
      });
