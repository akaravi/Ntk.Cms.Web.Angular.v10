...
export class TransactionAssistantInvoiceAddComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<TransactionAssistantInvoiceAddComponent>,
  ...
  appLanguage = "fa";
  dataModelResult: ErrorExceptionResult<transactionAssistantInvoiceModel> =
