...
export class ContactConfigSiteComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  ...
  dataSiteStorageModel = new ContactModuleSiteStorageValuesModel();
  dataConfigSiteValuesModel = new ContactModuleConfigSiteValuesModel();
  dataConfigSiteAccessValuesModel = new ContactModuleConfigSiteAccessValuesModel();
