...
import {
  AccessModel, ContactConfigurationService,
  ContactModuleConfigAdminMainValuesModel,
  ContactModuleConfigSiteAccessValuesModel,
  ContactModuleConfigSiteValuesModel, CoreEnumService,
  DataFieldInfoModel,
  FormInfoModel, TokenInfoModelV3
} from 'ntk-cms-api';
...
@Component({
  selector: 'app-contact-config-mainadmin',
  templateUrl: './config-main-admin.component.html',
  standalone: false
})
export class ContactConfigMainAdminComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  ...
  dataConfigSiteValuesDefaultModel = new ContactModuleConfigSiteValuesModel();
  dataConfigSiteAccessValuesDefaultModel = new ContactModuleConfigSiteAccessValuesModel();
  dataConfigAdminMainModel = new ContactModuleConfigAdminMainValuesModel();
