...
import {
  CatalogCategoryModel, CatalogCategoryService, CoreEnumService,
...
export class CatalogCategoryEditComponent extends EditBaseComponent<CatalogCategoryService, CatalogCategoryModel, string>
  implements OnInit {
  requestId = '';
  ...
  constructor(
    ...
    super(categoryService, new CatalogCategoryModel(), publicHelper, translate);
