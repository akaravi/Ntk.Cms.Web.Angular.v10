...
export class CatalogCategoryTreeSelectorComponent implements OnInit, OnDestroy {
  ...
  checklistSelection = new SelectionModel<CatalogCategoryModel>(true /* multiple */);


  hasChild = (_: string, node: CatalogCategoryModel) => !!node.children && node.children.length > 0;
  ...
  loadCheked(model: CatalogCategoryModel[] = this.treeControl.dataNodes): void {
