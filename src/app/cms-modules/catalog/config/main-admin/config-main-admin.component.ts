...
import {
  ...
  CatalogModuleConfigSiteValuesModel, CoreEnumService,
  DataFieldInfoModel,
...
@Component({
    selector: 'app-catalog-config-mainadmin',
    templateUrl: './config-main-admin.component.html',
    standalone: false
})
export class CatalogConfigMainAdminComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  ...
  dataConfigSiteValuesDefaultModel = new CatalogModuleConfigSiteValuesModel();
  dataConfigSiteAccessValuesDefaultModel = new CatalogModuleConfigSiteAccessValuesModel();
  dataConfigAdminMainModel = new CatalogModuleConfigAdminMainValuesModel();
