...
export class ApplicationAppEditComponent
  extends EditBaseComponent<ApplicationAppService, ApplicationAppModel, number>
  implements OnInit
{
  requestId = 0;
  ...
  DataGetOne(requestId: number): void {
    ...
    this.applicationAppService.setAccessDataType(
  ...
  DataEditContent(): void {
    ...
    this.applicationAppService.ServiceEdit(this.dataModel).subscribe({
      next: (ret) => {
