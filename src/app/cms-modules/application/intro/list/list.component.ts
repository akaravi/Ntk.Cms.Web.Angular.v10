...
export class ApplicationIntroListComponent extends ListBaseComponent<ApplicationIntroService, ApplicationIntroModel, number> implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    super(contentService, new ApplicationIntroModel(), publicHelper, tokenHelper, translate);
  ...
  onActionButtonNewRow(): void {
    ...
    if (ApplicationId <= 0) {
      this.translate.get('MESSAGE.No_application_selected').subscribe((str: string) => {
