...
export class ApplicationIntroEditComponent
  ...
  implements OnInit
{
  ...
  DataGetOne(requestId: number): void {
    ...
    this.applicationIntroService.setAccessDataType(
      ManageUserAccessDataTypesEnum.Editor,
    );
    this.applicationIntroService.ServiceGetOneById(requestId).subscribe({
      next: (ret) => {
        /*َAccess Field*/
  ...
  DataEditContent(): void {
    ...
    this.applicationIntroService.ServiceEdit(this.dataModel).subscribe({
      next: (ret) => {
