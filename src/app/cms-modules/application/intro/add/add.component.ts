...
export class ApplicationIntroAddComponent
  ...
  implements OnInit
{
  ...
  dataModelResult: ErrorExceptionResult<ApplicationIntroModel> =
    new ErrorExceptionResult<ApplicationIntroModel>();
  ...
  onFormSubmit(): void {
    ...
    if (this.dataModel.linkApplicationId <= 0) {
      this.translate
        .get("MESSAGE.Specify_the_application")
  ...
  DataAddContent(): void {
    ...
    this.applicationIntroService.ServiceAdd(this.dataModel).subscribe({
      next: (ret) => {
