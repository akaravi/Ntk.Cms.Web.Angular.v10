...
import {
  ApplicationConfigurationService, BaseModuleSiteCheckUserModel, CoreEnumService,
...
export class ApplicationConfigCheckUserComponent implements OnInit, OnDestroy {
  requestLinkUserId = 0;
