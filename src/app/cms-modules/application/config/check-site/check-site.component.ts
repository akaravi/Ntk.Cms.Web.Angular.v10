...
import {
  ApplicationConfigurationService, BaseModuleSiteCheckSiteModel, CoreEnumService,
...
export class ApplicationConfigCheckSiteComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
