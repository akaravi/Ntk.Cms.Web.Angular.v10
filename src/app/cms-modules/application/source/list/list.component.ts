...
export class ApplicationSourceListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  onActionButtonEditRow(
    model: ApplicationSourceModel = this.tableRowSelected,
  ): void {
  ...
  onActionButtonApplicationList(
    ...
    this.router.navigate([
      "/application/app/LinkSourceId",
      this.tableRowSelected.id,
    ]);
  }
  onActionButtonThemeList(
    model: ApplicationSourceModel = this.tableRowSelected,
  ): void {
    if (!model || !model.id || model.id === 0) {
      this.cmsToastrService.typeErrorSelectedRow();
    ...
    this.router.navigate([
      "/application/themeconfig/LinkSourceId",
      this.tableRowSelected.id,
    ]);
  }
  ...
  onActionButtonBuildApps(
    mode: ApplicationSourceModel = this.tableRowSelected,
  ): void {
