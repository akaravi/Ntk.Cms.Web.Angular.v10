...
export class ApplicationMemberInfoSelectorComponent implements OnInit {
  ...
  dataModelResult: ErrorExceptionResult<ApplicationMemberInfoModel> =
    new ErrorExceptionResult<ApplicationMemberInfoModel>();
  dataModelSelect: ApplicationMemberInfoModel =
    new ApplicationMemberInfoModel();
  ...
  displayFn(model?: ApplicationMemberInfoModel): string | undefined {
    return model
      ? model.deviceId + " # APP:" + model.linkApplicationId
      : undefined;
  }
  ...
  ): Promise<ApplicationMemberInfoModel[]> {
  ...
  push(
    newvalue: ApplicationMemberInfoModel,
  ): Observable<ApplicationMemberInfoModel[]> {
