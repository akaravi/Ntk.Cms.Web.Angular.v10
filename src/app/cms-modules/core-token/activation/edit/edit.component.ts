...
export class CoreTokenActivationEditComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  dataModelResult: ErrorExceptionResult<CoreTokenActivationModel> =
  ...
  DataGetOneContent(): void {
    ...
    this.coreTokenActivationService.setAccessDataType(
      ManageUserAccessDataTypesEnum.Editor,
    );
    this.coreTokenActivationService
