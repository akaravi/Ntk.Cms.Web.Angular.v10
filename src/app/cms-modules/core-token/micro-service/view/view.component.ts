...
export class CoreTokenMicroServiceViewComponent implements OnInit, OnDestroy {
  requestId = "";
  ...
  dataModelResult: ErrorExceptionResult<CoreTokenMicroServiceModel> =
    new ErrorExceptionResult<CoreTokenMicroServiceModel>();
