...
import {
  CoreEnumService, CoreSiteModel, CoreTokenUserBadLoginModel, CoreTokenUserBadLoginService,
...
export class CoreTokenUserBadLoginListComponent extends ListBaseComponent<CoreTokenUserBadLoginService, CoreTokenUserBadLoginModel, string>
  ...
  constructor(
    ...
    super(contentService, new CoreTokenUserBadLoginModel(), publicHelper, tokenHelper, translate);
