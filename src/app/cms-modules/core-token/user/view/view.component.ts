...
export class CoreTokenUserViewComponent implements OnInit, OnDestroy {
  requestId = "";
  constructorInfoAreaId = this.constructor.name;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<CoreTokenUserViewComponent>,
  ...
  dataModelResult: ErrorExceptionResult<CoreTokenUserModel> =
    new ErrorExceptionResult<CoreTokenUserModel>();
