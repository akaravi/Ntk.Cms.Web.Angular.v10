...
export class CoreTokenUserListComponent extends ListBaseComponent<CoreTokenUserService, CoreTokenUserModel, string>
  ...
  constructor(
    ...
    super(contentService, new CoreTokenUserModel(), publicHelper, tokenHelper, translate);
