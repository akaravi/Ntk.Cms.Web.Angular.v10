...
export class CoreTokenUserEditComponent
  extends EditBaseComponent<CoreTokenUserService, CoreTokenUserModel, string>
  implements OnInit, OnDestroy
{
  ...
  DataGetOneContent(): void {
    ...
    this.coreTokenUserService.setAccessDataType(
