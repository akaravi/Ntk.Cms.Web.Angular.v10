...
export class CoreLogTokenConnectionEditComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  dataModelResult: ErrorExceptionResult<CoreLogTokenConnectionModel> =
  ...
  DataGetOneContent(): void {
    ...
    this.coreLogTokenConnectionService.setAccessDataType(
      ManageUserAccessDataTypesEnum.Editor,
    );
    this.coreLogTokenConnectionService
