...
import { ApiTelegramMemberInfoListComponent } from "./list.component";

@Component({
  selector: "app-apitelegram-member-info-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class ApiTelegramMemberInfoListMobileComponent extends ApiTelegramMemberInfoListComponent {
