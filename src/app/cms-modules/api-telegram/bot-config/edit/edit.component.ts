...
export class ApiTelegramBotConfigEditComponent
  ...
  implements OnInit
{
  ...
  DataGetOneContent(): void {
    ...
    this.apiTelegramBotConfigService.setAccessDataType(
  ...
  onActionButtonGetMeAsync(): void {
    ...
    this.apiTelegramBotConfigService
      .ServiceGetMeAsync(this.requestId)
      .subscribe({
        next: (ret) => {
          if (ret.isSuccess) {
            //open popup
  ...
  onActionButtonSetWebhookAsync(): void {
    ...
    this.apiTelegramBotConfigService
      .ServiceSetWebhookAsync(this.requestId)
      .subscribe({
        next: (ret) => {
          if (ret.isSuccess) {
  ...
  onActionButtonSetWebhookAsyncEmpty(): void {
    ...
    this.apiTelegramBotConfigService
      .ServiceSetWebhookAsyncEmpty(this.requestId)
      .subscribe({
        next: (ret) => {
          if (ret.isSuccess) {
            this.cmsToastrService.typeSuccessAdd();
