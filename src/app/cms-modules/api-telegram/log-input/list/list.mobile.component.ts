...
import { ApiTelegramLogInputListComponent } from "./list.component";

@Component({
  selector: "app-apitelegram-log-input-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class ApiTelegramLogInputListMobileComponent extends ApiTelegramLogInputListComponent {
