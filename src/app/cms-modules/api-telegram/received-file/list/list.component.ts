...
export class ApiTelegramReceivedFileListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    super(
      contentService,
      new ApiTelegramReceivedFileModel(),
      publicHelper,
      tokenHelper,
      translate,
    );
  ...
  dataModelResult: ErrorExceptionResult<ApiTelegramReceivedFileModel> =
    new ErrorExceptionResult<ApiTelegramReceivedFileModel>();
  ...
  onActionButtonEditRow(
    model: ApiTelegramReceivedFileModel = this.tableRowSelected,
  ): void {}
