...
import { ApiTelegramReceivedFileListComponent } from "./list.component";

@Component({
  selector: "app-apitelegram-received-file-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class ApiTelegramReceivedFileListMobileComponent extends ApiTelegramReceivedFileListComponent {
