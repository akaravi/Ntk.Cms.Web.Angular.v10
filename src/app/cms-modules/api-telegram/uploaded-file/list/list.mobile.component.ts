...
import { ApiTelegramUploadedFileListComponent } from "./list.component";

@Component({
  selector: "app-apitelegram-uploaded-file-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class ApiTelegramUploadedFileListMobileComponent extends ApiTelegramUploadedFileListComponent {
