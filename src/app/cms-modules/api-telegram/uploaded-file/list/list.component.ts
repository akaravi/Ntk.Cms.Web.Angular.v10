...
export class ApiTelegramUploadedFileListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    super(
      contentService,
      new ApiTelegramUploadedFileModel(),
      publicHelper,
      tokenHelper,
      translate,
    );
  ...
  dataModelResult: ErrorExceptionResult<ApiTelegramUploadedFileModel> =
    new ErrorExceptionResult<ApiTelegramUploadedFileModel>();
  ...
  onActionButtonEditRow(
    model: ApiTelegramUploadedFileModel = this.tableRowSelected,
  ): void {}
  ...
  onActionButtonSiteCategoryList(
    ...
    this.router.navigate([
      "core/sitecategorymodule/LinkCmsModuleId/",
      model.id,
    ]);
  }
