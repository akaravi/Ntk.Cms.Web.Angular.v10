...
import {CoreEnumService,
  ...
  FileCategoryModel,
  FileCategoryService,ManageUserAccessDataTypesEnum} from "ntk-cms-api";
...
export class FileCategoryEditComponent
  extends EditBaseComponent<FileCategoryService, FileCategoryModel, number>
  implements OnInit
{
  requestId = 0;
  requestParentId = 0;
