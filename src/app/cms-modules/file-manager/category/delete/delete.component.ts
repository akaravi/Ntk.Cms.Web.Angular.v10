...
export class FileCategoryDeleteComponent implements OnInit {
  ...
  dataModelResultCategory: ErrorExceptionResult<FileCategoryModel> =
    new ErrorExceptionResult<FileCategoryModel>();
  dataModelResultCategoryAllData: ErrorExceptionResult<FileCategoryModel> =
    new ErrorExceptionResult<FileCategoryModel>();
  dataModel: any = {};
  ...
  DataGetOne(): void {
    ...
    this.fileCategoryService.setAccessDataType(
  ...
  DataGetAll(): void {
    ...
    this.fileCategoryService.ServiceGetAll(filterModel).subscribe({
      next: (ret) => {
  ...
  onFormDelete(): void {
    ...
    this.fileCategoryService.ServiceDelete(this.requestId).subscribe({
      next: (ret) => {
