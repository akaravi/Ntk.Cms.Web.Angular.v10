...
import { WebDesignerMainPageListComponent } from "./list.component";

@Component({
  selector: "app-web-designer-main-page-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class WebDesignerMainPageListMobileComponent extends WebDesignerMainPageListComponent {
