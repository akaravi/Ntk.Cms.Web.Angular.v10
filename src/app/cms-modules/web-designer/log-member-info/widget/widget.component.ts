...
export class WebDesignerLogMemberInfoWidgetComponent
  implements OnInit, OnDestroy
{
  ...
  ngOnInit() {
    this.translate.get("TITLE.Registered_Member").subscribe((str: string) => {
  ...
  onActionStatist(): void {
    this.translate
      .get([
        "MESSAGE.Get_active_registered_members",
        "MESSAGE.Get_all_registered_members",
      ])
      .subscribe((str: any) => {
        this.publicHelper.processService.processStart(
          this.constructor.name + "Active",
          str["MESSAGE.Get_active_registered_members"],
          this.constructorInfoAreaId,
        );
        this.publicHelper.processService.processStart(
          this.constructor.name + "All",
          str["MESSAGE.Get_all_registered_members"],
          this.constructorInfoAreaId,
        );
      });
