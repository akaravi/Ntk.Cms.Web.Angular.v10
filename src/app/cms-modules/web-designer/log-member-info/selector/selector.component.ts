...
export class WebDesignerLogMemberInfoSelectorComponent implements OnInit {
  ...
  dataModelResult: ErrorExceptionResult<WebDesignerLogMemberInfoModel> =
    new ErrorExceptionResult<WebDesignerLogMemberInfoModel>();
  dataModelSelect: WebDesignerLogMemberInfoModel =
    new WebDesignerLogMemberInfoModel();
  ...
  ): Promise<WebDesignerLogMemberInfoModel[]> {
  ...
  push(
    newvalue: WebDesignerLogMemberInfoModel,
  ): Observable<WebDesignerLogMemberInfoModel[]> {
