...
import {
  ...
  DataFieldInfoModel,
  FormInfoModel,
  TokenInfoModelV3, WebDesignerConfigurationService,
...
@Component({
  selector: 'app-webdesigner-config-site',
  templateUrl: './config-site.component.html',
  standalone: false
})
export class WebDesignerConfigSiteComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  ...
  dataConfigSiteValuesModel = new WebDesignerModuleConfigSiteValuesModel();
  dataConfigSiteAccessValuesModel = new WebDesignerModuleConfigSiteAccessValuesModel();
