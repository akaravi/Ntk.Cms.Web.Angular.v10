...
import {
  ClauseTypeEnum, CoreEnumService, ErrorExceptionResult, EstatePropertyDetailModel,
  EstatePropertyDetailService, FilterDataModel, FilterDataModelSearchTypesEnum, FilterModel
} from 'ntk-cms-api';
