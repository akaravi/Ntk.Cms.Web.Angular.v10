...
import {CoreEnumService,
  ...
  EstatePropertyTypeLanduseModel,InfoEnumModel,
...
export class EstatePropertyDetailEditComponent
        ...
        next: (ret) => {
          ...
          if (ret.isSuccess) {
            ...
            this.keywordDefaultDataModel =
              this.dataModel.configValueDefaultValueJson.split(",");
            this.keywordNullDataModel =
