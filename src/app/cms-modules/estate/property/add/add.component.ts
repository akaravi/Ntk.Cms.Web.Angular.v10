...
import {
  ...
  FilterModel, FormInfoModel, InputDataTypeEnum, ManageUserAccessUserTypesEnum, RecordStatusEnum, TokenInfoModelV3
} from 'ntk-cms-api';
...
export class EstatePropertyAddComponent extends AddBaseComponent<EstatePropertyService, EstatePropertyModel, string> implements OnInit, OnDestroy {
