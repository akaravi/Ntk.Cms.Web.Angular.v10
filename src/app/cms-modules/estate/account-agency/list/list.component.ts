...
export class EstateAccountAgencyListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  @Input() set optionLinkLocationWorkAreaIds(ids: number[]) {
    ...
    if (
      this.requestLinkLocationWorkAreaIds &&
      this.requestLinkLocationWorkAreaIds.length > 0
    )
      this.filteModelContent.linkLocationWorkAreaIds =
        this.requestLinkLocationWorkAreaIds;
  }
  ...
  DataGetAll(): void {
    ...
    if (
      this.requestLinkAccountUserId &&
      this.requestLinkAccountUserId.length > 0
    ) {
  ...
  onActionButtonAgentRow(
    mode: EstateAccountAgencyModel = this.tableRowSelected,
    event?: MouseEvent,
  ): void {
    ...
    if (event?.ctrlKey) {
      this.link =
        "/#/estate/account-user/LinkAccountAgencyId/" +
  ...
  onActionButtonHistoryRow(
    ...
    if (event?.ctrlKey) {
      this.link =
        "/#/estate/property-history/LinkEstateAgencyId/" +
        this.tableRowSelected.id;
      window.open(this.link, "_blank");
    } else {
      this.router.navigate([
  ...
  onActionButtonPropertyRow(
    ...
    if (event?.ctrlKey) {
      this.link =
        "/#/estate/property/LinkEstateAgencyId/" + this.tableRowSelected.id;
      window.open(this.link, "_blank");
    } else {
      this.router.navigate([
        "/estate/property/LinkEstateAgencyId",
        this.tableRowSelected.id,
      ]);
    }
  }
