...
import {
  ...
  EstatePropertyTypeUsageService, FilterDataModel, FilterModel, RecordStatusEnum, SortTypeEnum
} from 'ntk-cms-api';
...
export class EstatePropertyTypeUsageListComponent extends ListBaseComponent<EstatePropertyTypeUsageService, EstatePropertyTypeUsageModel, string> implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    super(contentService, new EstatePropertyTypeUsageModel(), publicHelper, tokenHelper, translate);
