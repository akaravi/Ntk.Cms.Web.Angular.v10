...
import {CoreEnumService,
  ...
  EstatePropertySupplierService,InputDataTypeEnum,
...
export class EstatePropertySupplierQuickViewComponent
  implements OnInit, OnDestroy
{
  ...
  DataGetOneContent(): void {
    ...
    this.estatePropertySupplierService.setAccessDataType(
