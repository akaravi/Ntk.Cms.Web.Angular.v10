...
export class EstatePropertySupplierSelectorComponent implements OnInit {
  static nextId = 0;
  id = ++EstatePropertySupplierSelectorComponent.nextId;
  ...
  ): Promise<EstatePropertySupplierModel[]> {
  ...
  push(
    newvalue: EstatePropertySupplierModel,
  ): Observable<EstatePropertySupplierModel[]> {
