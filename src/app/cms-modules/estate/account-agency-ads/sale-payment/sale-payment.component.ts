...
import {BankPaymentInjectPaymentGotoBankStep1CalculateModel,
  ...
  EstateModuleSaleAccountAgencyAdsPaymentDtoModel} from "ntk-cms-api";
...
export class EstateAccountAgencyAdsSalePaymentComponent implements OnInit {
  ...
  constructor(
    ...
    this.dataModelCalculate.linkAccountAgencyId =
  ...
  dataModelCalculate: EstateModuleSaleAccountAgencyAdsCalculateDtoModel =
    new EstateModuleSaleAccountAgencyAdsCalculateDtoModel();
  dataModelPayment: EstateModuleSaleAccountAgencyAdsPaymentDtoModel =
    new EstateModuleSaleAccountAgencyAdsPaymentDtoModel();
