...
import {DataFieldInfoModel,
  ...
  EstatePropertyCompanyService,ManageUserAccessDataTypesEnum} from "ntk-cms-api";
...
export class EstatePropertyCompanyDeleteComponent implements OnInit {
  requestId = "";
  constructorInfoAreaId = this.constructor.name;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<EstatePropertyCompanyDeleteComponent>,
  ...
  dataModelResultContent: ErrorExceptionResult<EstatePropertyCompanyModel> =
