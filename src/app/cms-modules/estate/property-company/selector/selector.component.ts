...
export class EstatePropertyCompanySelectorComponent implements OnInit {
  ...
  dataModelSelect: EstatePropertyCompanyModel =
  ...
  async DataGetAll(
  ...
  ): Promise<EstatePropertyCompanyModel[]> {
    ...
    return firstValueFrom(this.contentService.ServiceGetAll(filterModel)).then(
      (response) => {
  ...
  push(
    newvalue: EstatePropertyCompanyModel,
  ): Observable<EstatePropertyCompanyModel[]> {
