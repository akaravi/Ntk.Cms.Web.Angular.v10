...
import {CoreEnumService,
  ...
  EstatePropertyCompanyService,InputDataTypeEnum,
...
export class EstatePropertyCompanyQuickViewComponent
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<EstatePropertyCompanyQuickViewComponent>,
  ...
  dataModelResult: ErrorExceptionResult<EstatePropertyCompanyModel> =
  ...
  DataGetOneContent(): void {
    ...
    /*َAccess Field*/
    this.estatePropertyCompanyService.setAccessLoad();
    this.estatePropertyCompanyService.setAccessDataType(
  ...
  onActionNext(): void {
    this.dialogRef.close({
      ...
      onActionOpenItem: this.requestNextItem,
    });
  }
  onActionPervious(): void {
    this.dialogRef.close({
      dialogChangedDate: true,
      onActionOpenItem: this.requestPerviousItem,
    });
  }
}
