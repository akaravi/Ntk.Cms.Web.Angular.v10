...
import {
  ...
  EstatePropertyCompanyService, FormInfoModel, InputDataTypeEnum, ManageUserAccessDataTypesEnum, TokenInfoModelV3
} from 'ntk-cms-api';
...
export class EstatePropertyCompanyQuickViewComponent implements OnInit, OnDestroy {
  ...
  DataGetOneContent(): void {
    ...
    this.estatePropertyCompanyService.setAccessDataType(ManageUserAccessDataTypesEnum.Editor);
    this.estatePropertyCompanyService.ServiceGetOneById(this.requestId).subscribe({
      next: (ret) => {
        /*َAccess Field*/
