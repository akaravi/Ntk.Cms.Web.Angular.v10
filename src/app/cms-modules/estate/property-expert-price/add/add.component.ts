...
import {
  ...
  EstatePropertyExpertPriceService, EstatePropertyTypeLanduseModel, EstatePropertyTypeUsageModel, FormInfoModel, InfoEnumModel, TokenInfoModelV3
} from 'ntk-cms-api';
...
export class EstatePropertyExpertPriceAddComponent extends AddBaseComponent<EstatePropertyExpertPriceService, EstatePropertyExpertPriceModel, string> implements OnInit {
  ...
  constructor(
    ...
    super(estatePropertyExpertPriceService, new EstatePropertyExpertPriceModel(), publicHelper, translate);
