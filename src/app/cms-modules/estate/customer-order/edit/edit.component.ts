  ...
  implements OnInit
{
  ...
  estatePropertyListComponent: EstatePropertyListComponent;
  @ViewChild(EstatePropertyListComponent)
  estatePropertyHaveHistoryListComponent: EstatePropertyListComponent;
  ...
  DataGetOneContent(): void {
    ...
    this.estateCustomerOrderService.setAccessDataType(
          ...
          if (ret.isSuccess) {
            ...
            if (this.dataModel.linkContractTypeId.length > 0) {
              this.estateContractTypeService
                .ServiceGetOneById(this.dataModel.linkContractTypeId)
                .subscribe({
                  next: (ret) => {
                    if (ret.isSuccess) {
