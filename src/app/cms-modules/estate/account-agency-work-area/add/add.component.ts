...
import {
  CoreEnumService, CoreLocationModel, DataFieldInfoModel, ErrorExceptionResult, EstateAccountAgencyModel, EstateAccountAgencyWorkAreaModel, EstateAccountAgencyWorkAreaService, EstateEnumService, FormInfoModel, InfoEnumModel, TokenInfoModelV3
} from 'ntk-cms-api';
...
export class EstateAccountAgencyWorkAreaAddComponent extends AddBaseComponent<EstateAccountAgencyWorkAreaService, EstateAccountAgencyWorkAreaModel, string> implements OnInit {
  ...
  constructor(
    ...
    super(estateAccountAgencyWorkAreaService, new EstateAccountAgencyWorkAreaModel(), publicHelper, translate);
