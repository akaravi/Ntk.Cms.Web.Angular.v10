...
import {CoreEnumService,
  ...
  EstateEnumService,InfoEnumModel,
...
export class EstateAccountAgencyWorkAreaAddComponent
  ...
  implements OnInit
{
  ...
  dataModelResult: ErrorExceptionResult<EstateAccountAgencyWorkAreaModel> =
    new ErrorExceptionResult<EstateAccountAgencyWorkAreaModel>();
  dataModel: EstateAccountAgencyWorkAreaModel =
    new EstateAccountAgencyWorkAreaModel();
