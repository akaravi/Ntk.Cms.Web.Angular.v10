...
import {
  ...
  EstateAccountAgencyExpertService, FilterDataModel, FilterModel, RecordStatusEnum, SortTypeEnum
} from 'ntk-cms-api';
...
export class EstateAccountAgencyExpertListComponent extends ListBaseComponent<EstateAccountAgencyExpertService, EstateAccountAgencyExpertModel, string> implements OnInit, OnDestroy {
  ...
  constructor(
    private contentService: EstateAccountAgencyExpertService,
    ...
    super(contentService, new EstateAccountAgencyExpertModel(), publicHelper, tokenHelper, translate);
  ...
  expandedElement: EstateAccountAgencyExpertModel | null;
...
if (this.tokenInfo) {
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new EstateAccountAgencyExpertModel());
  ...
  onActionButtonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(EstateAccountAgencyExpertAddComponent, {
      height: '90%',
  ...
  onActionButtonDeleteRow(model: EstateAccountAgencyExpertModel = this.tableRowSelected): void {
  ...
  onActionButtonContentList(model: EstateAccountAgencyExpertModel = this.tableRowSelected): void {
