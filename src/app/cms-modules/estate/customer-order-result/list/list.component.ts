...
import {
  ...
  EstateCustomerOrderResultService, FilterDataModel, FilterModel, RecordStatusEnum, SortTypeEnum
} from 'ntk-cms-api';
...
export class EstateCustomerOrderResultListComponent extends ListBaseComponent<EstateCustomerOrderResultService, EstateCustomerOrderResultModel, string> implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    super(contentService, new EstateCustomerOrderResultModel(), publicHelper, tokenHelper, translate);
