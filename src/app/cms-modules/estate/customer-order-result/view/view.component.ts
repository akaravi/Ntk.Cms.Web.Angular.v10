...
import {
  CoreEnumService, DataFieldInfoModel, ErrorExceptionResult, EstateCustomerOrderResultModel,
  EstateCustomerOrderResultService, FormInfoModel, TokenInfoModelV3
} from 'ntk-cms-api';
...
export class EstateCustomerOrderResultViewComponent implements OnInit, OnDestroy {
  ...
  dataModel: EstateCustomerOrderResultModel = new EstateCustomerOrderResultModel();
  ...
  DataGetOneContent(): void {
    ...
    this.estateCustomerOrderResultService.ServiceGetOneById(this.requestId).subscribe({
      next: (ret) => {
        /*َAccess Field*/
