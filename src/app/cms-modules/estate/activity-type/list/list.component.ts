...
import {
  ...
  EstateActivityTypeService, FilterDataModel, FilterModel, RecordStatusEnum, SortTypeEnum
} from 'ntk-cms-api';
...
export class EstateActivityTypeListComponent extends ListBaseComponent<EstateActivityTypeService, EstateActivityTypeModel, string> implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    super(contentService, new EstateActivityTypeModel(), publicHelper, tokenHelper, translate);
