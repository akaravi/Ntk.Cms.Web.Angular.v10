...
import {CoreEnumService,
  ...
  EstateCustomerOrderResultService,TokenInfoModelV3} from "ntk-cms-api";
...
export class EstateCustomerOrderResultViewComponent
  implements OnInit, OnDestroy
{
  ...
  dataModelResult: ErrorExceptionResult<EstateCustomerOrderResultModel> =
    new ErrorExceptionResult<EstateCustomerOrderResultModel>();
  dataModel: EstateCustomerOrderResultModel =
  ...
  DataGetOneContent(): void {
    ...
    /*َAccess Field*/
    this.estateCustomerOrderResultService.setAccessLoad();

    this.estateCustomerOrderResultService
