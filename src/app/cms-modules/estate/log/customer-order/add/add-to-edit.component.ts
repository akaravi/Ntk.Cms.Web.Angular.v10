...
import {CoreEnumService,
  ...
  EstateCustomerOrderService,ManageUserAccessDataTypesEnum} from "ntk-cms-api";
...
export class EstateCustomerOrderAddToEditComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    if (data && data.linkEstateCustomerCategoryId?.length > 0) {
      this.dataModel.linkEstateCustomerCategoryId =
        data.linkEstateCustomerCategoryId;
    }
