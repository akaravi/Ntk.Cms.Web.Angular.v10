...
export class EstateCustomerOrderEditMobileComponent
  ...
  implements OnInit
{
  ...
  onActionButtonQuickViewRow(model: EstatePropertyModel): void {
    ...
    var nextItem = this.publicHelper.InfoNextRowInList(
      this.dataModelEstatePropertyResult.listItems,
      model,
    );
