...
export class EstatePropertyHistoryListComponent
  ...
  implements OnInit, OnDestroy, AfterViewInit
{
  ...
  constructor(
    ...
    /**ActivityStatus */
    this.requestActivityStatus =
      ActivityStatusEnumEstate[
        this.activatedRoute.snapshot.paramMap.get("ActivityStatus") + ""
      ];
    /**ActivityStatus */
    ...
    if (this.activatedRoute.snapshot.paramMap.get("InCheckingPlanedToDay")) {
      ...
      this.searchInCheckingPlanedToDayUserId =
        +this.activatedRoute.snapshot.paramMap.get("InCheckingPlanedToDay") | 0;
    }
  ...
  getActivityTypeList(): void {
    ...
    this.estateActivityTypeService.ServiceGetAllEditor(filter).subscribe({
      next: (ret) => {
  ...
  DataGetAll(): void {
    ...
    if (this.searchInCheckingPlanedToDay) {
      const filter = new FilterDataModel();
      const hours = 48;
      filterModel.onDateTimeFrom = new Date(
      ...
      if (this.searchInCheckingPlanedToDayUserId === 0)
        ...
        filterModel.linkResponsibleUserId =
          this.searchInCheckingPlanedToDayUserId;
      filter.propertyName = "activityStatus";
      filter.value = ActivityStatusEnumEstate.Planned;
