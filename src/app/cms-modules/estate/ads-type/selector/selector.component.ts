...
import {
  ClauseTypeEnum, CoreEnumService, ErrorExceptionResult, EstateAdsTypeModel,
  EstateAdsTypeService, FilterDataModel, FilterDataModelSearchTypesEnum, FilterModel
} from 'ntk-cms-api';
...
export class EstateAdsTypeSelectorComponent implements OnInit {
  static nextId = 0;
  id = ++EstateAdsTypeSelectorComponent.nextId;
