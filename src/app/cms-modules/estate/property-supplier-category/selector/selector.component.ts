...
export class EstatePropertySupplierCategorySelectorComponent
  implements OnInit, OnDestroy
{
  ...
  @Input() set optionSelectForce(
    x: string | EstatePropertySupplierCategoryModel,
  ) {
  ...
  displayOption(
    model?: EstatePropertySupplierCategoryModel,
  ): string | undefined {
    return model ? model.title : undefined;
  }
  async DataGetAll(
    text: string | number | any,
  ): Promise<EstatePropertySupplierCategoryModel[]> {
  ...
  push(
    newvalue: EstatePropertySupplierCategoryModel,
  ): Observable<EstatePropertySupplierCategoryModel[]> {
  ...
  onActionSelectForce(id: string | EstatePropertySupplierCategoryModel): void {
    ...
    if (typeof id === typeof EstatePropertySupplierCategoryModel) {
      this.filteredOptions = this.push(
        id as EstatePropertySupplierCategoryModel,
      );
