...
import {
  AccessModel,
  CoreEnumService,
  DataFieldInfoModel, EstateConfigurationService,
  EstateModuleConfigAdminMainValuesModel,
  EstateModuleConfigSiteAccessValuesModel,
  EstateModuleConfigSiteValuesModel, FormInfoModel, TokenInfoModelV3
} from 'ntk-cms-api';
...
export class EstateConfigMainAdminComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  ...
  dataConfigSiteValuesDefaultModel = new EstateModuleConfigSiteValuesModel();
  dataConfigSiteAccessValuesDefaultModel = new EstateModuleConfigSiteAccessValuesModel();
  dataConfigAdminMainModel = new EstateModuleConfigAdminMainValuesModel();
