...
import {
  ...
  ErrorExceptionResult, EstateConfigurationService, TokenInfoModelV3
} from 'ntk-cms-api';
...
@Component({
  selector: 'app-estate-config-checkuser',
  templateUrl: './check-user.component.html',
  styleUrls: ['./check-user.component.scss'],
  standalone: false
})
export class EstateConfigCheckUserComponent implements OnInit, OnDestroy {
  requestLinkUserId = 0;
