...
import { EstateAccountAgencyExpertListComponent } from "./list.component";

@Component({
  selector: "app-estate-account-agency-expert-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class EstateAccountAgencyExpertListMobileComponent extends EstateAccountAgencyExpertListComponent {
