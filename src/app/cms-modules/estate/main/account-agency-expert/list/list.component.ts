...
export class EstateAccountAgencyExpertListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  onActionButtonDeleteRow(
    model: EstateAccountAgencyExpertModel = this.tableRowSelected,
  ): void {
    if (
      !model ||
      !model.linkEstateAccountAgencyId ||
      model.linkEstateAccountAgencyId.length === 0 ||
      !model.linkEstateExpertId ||
      model.linkEstateExpertId.length === 0
    ) {
      this.translate
  ...
  onActionButtonContentList(
    ...
    this.router.navigate([
      ...
      this.tableRowSelected.linkEstateExpertId,
    ]);
  }
