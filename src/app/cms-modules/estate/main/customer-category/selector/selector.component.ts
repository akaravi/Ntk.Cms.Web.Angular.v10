...
export class EstateCustomerCategorySelectorComponent
  implements OnInit, OnDestroy
{
  ...
  ): Promise<EstateCustomerCategoryModel[]> {
  ...
  push(
    newvalue: EstateCustomerCategoryModel,
  ): Observable<EstateCustomerCategoryModel[]> {
