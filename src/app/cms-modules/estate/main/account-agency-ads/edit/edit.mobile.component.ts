...
@Component({
  selector: "app-estate-account-agency-ads-edit-mobile",
  templateUrl: "./edit.mobile.component.html",
  styleUrls: ["./edit.mobile.component.scss"],
  standalone: false,
})
export class EstateAccountAgencyAdsEditMobileComponent
  ...
  implements OnInit
{
  ...
  onActionSelectorSelectLinkAdsTypeId(model: any): void {
    this.dataModel.linkAdsTypeId = null;
    if (model && model.id && model.id.length > 0) {
  ...
  onActionBackToParent(): void {
    this.router.navigate(["/estate/main/account-agency-ads"]);
  }
}
