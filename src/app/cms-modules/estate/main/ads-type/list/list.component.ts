...
export class EstateAdsTypeListComponent
  extends ListBaseComponent<EstateAdsTypeService, EstateAdsTypeModel, string>
  implements OnInit, OnDestroy
{
  ...
  onActionButtonEditRow(
    model: EstateAdsTypeModel = this.tableRowSelected,
  ): void {
