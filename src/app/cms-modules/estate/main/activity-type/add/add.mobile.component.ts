...
import {
  ...
  EstateActivityTypeService } from "ntk-cms-api";
...
@Component({
  selector: "app-estate-activity-type-add-mobile",
  templateUrl: "./add.mobile.component.html",
  styleUrls: ["./add.mobile.component.scss"],
  standalone: false,
})
export class EstateActivityTypeAddMobileComponent
  ...
  implements OnInit
{
  ...
  onActionBackToParent(): void {
    this.router.navigate(["/estate/main/activity-type"]);
  }
}
