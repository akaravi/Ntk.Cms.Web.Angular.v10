...
export class EstatePropertySupplierCategoryTreeSelectorComponent
  implements OnInit, OnDestroy
{
  ...
  checklistSelection = new SelectionModel<EstatePropertySupplierCategoryModel>(
    true /* multiple */,
  );
  ...
  descendantsPartiallySelected(
    node: EstatePropertySupplierCategoryModel,
  ): boolean {
    const descendants = this.treeControl.getDescendants(node);
