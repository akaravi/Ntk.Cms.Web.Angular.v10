...
import {
  ...
  EstatePropertyDetailService } from "ntk-cms-api";
...
@Component({
  selector: "app-estate-property-detail-add-mobile",
  templateUrl: "./add.mobile.component.html",
  styleUrls: ["./add.mobile.component.scss"],
  standalone: false,
})
export class EstatePropertyDetailAddMobileComponent
  ...
  implements OnInit
{
  ...
  onActionSelectorDetailGroup(model: any): void {
    this.dataModel.linkPropertyDetailGroupId = null;
    if (model && model.id && model.id.length > 0) {
