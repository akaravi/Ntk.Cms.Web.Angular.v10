...
export class EstatePropertyDetailGroupSelectorComponent implements OnInit {
  ...
  async DataGetAll(
  ...
  ): Promise<EstatePropertyDetailGroupModel[]> {
    ...
    if (
      this.linkPropertyTypeLanduseId &&
      this.linkPropertyTypeLanduseId.length > 0
    ) {
  ...
  push(
    newvalue: EstatePropertyDetailGroupModel,
  ): Observable<EstatePropertyDetailGroupModel[]> {
