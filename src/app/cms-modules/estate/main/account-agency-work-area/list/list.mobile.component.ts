...
import { EstateAccountAgencyWorkAreaListComponent } from "./list.component";

@Component({
  selector: "app-estate-account-agency-work-area-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class EstateAccountAgencyWorkAreaListMobileComponent extends EstateAccountAgencyWorkAreaListComponent {
