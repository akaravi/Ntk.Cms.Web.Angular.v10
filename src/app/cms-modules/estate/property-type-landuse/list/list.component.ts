...
import {
  ...
  EstatePropertyTypeLanduseService, FilterDataModel, FilterModel, RecordStatusEnum, SortTypeEnum
} from 'ntk-cms-api';
...
export class EstatePropertyTypeLanduseListComponent extends ListBaseComponent<EstatePropertyTypeLanduseService, EstatePropertyTypeLanduseModel, string> implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    super(contentService, new EstatePropertyTypeLanduseModel(), publicHelper, tokenHelper, translate);
