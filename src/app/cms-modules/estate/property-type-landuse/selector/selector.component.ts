...
export class EstatePropertyTypeLanduseSelectorComponent
  implements OnInit, OnDestroy
{
  ...
  @Input() set optionSelectForce(x: string | EstatePropertyTypeLanduseModel) {
    if (
      ...
      ((typeof x === "string" && x.length > 0) ||
        typeof x === typeof EstatePropertyTypeLanduseModel)
    )
  ...
  ): Promise<EstatePropertyTypeLanduseModel[]> {
  ...
  push(
    newvalue: EstatePropertyTypeLanduseModel,
  ): Observable<EstatePropertyTypeLanduseModel[]> {
