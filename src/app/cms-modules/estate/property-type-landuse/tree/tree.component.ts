...
export class EstatePropertyTypeLanduseTreeComponent
  implements OnInit, OnDestroy
{
  ...
  treeControl = new NestedTreeControl<EstatePropertyTypeLanduseModel>(
    (node) => null,
  );
  ...
  childrenAccessor = (node: EstatePropertyTypeLanduseModel) => [];
