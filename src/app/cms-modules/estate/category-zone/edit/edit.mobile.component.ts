...
@Component({
  selector: "app-estate-category-zone-edit-mobile",
  templateUrl: "./edit.mobile.component.html",
  styleUrls: ["./edit.mobile.component.scss"],
  standalone: false,
})
export class EstateCategoryZoneEditMobileComponent
  ...
  implements OnInit
{
  ...
  DataGetOneContent(): void {
    ...
    this.estateCategoryZoneService.setAccessDataType(
  ...
  onActionBackToParent(): void {
    this.router.navigate(["/estate/main/category-zone"]);
  }
}
