...
import {BankPaymentInjectPaymentGotoBankStep1CalculateModel,
  ...
  EstatePropertyAdsService} from "ntk-cms-api";
...
export class EstatePropertyAdsSalePaymentComponent implements OnInit {
  ...
  dataModelCalculate: EstateModuleSalePropertyAdsCalculateDtoModel =
    new EstateModuleSalePropertyAdsCalculateDtoModel();
  dataModelPayment: EstateModuleSalePropertyAdsPaymentDtoModel =
    new EstateModuleSalePropertyAdsPaymentDtoModel();
