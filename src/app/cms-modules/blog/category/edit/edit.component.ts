...
import {
  BlogCategoryModel, BlogCategoryService, CoreEnumService,
...
export class BlogCategoryEditComponent extends EditBaseComponent<BlogCategoryService, BlogCategoryModel, number>
  implements OnInit {
  requestId = 0;
  ...
  constructor(
    ...
    super(categoryService, new BlogCategoryModel(), publicHelper, translate);
