...
export class ArticleCommentEditComponent
  extends EditBaseComponent<ArticleCommentService, ArticleCommentModel, number>
  implements OnInit
{
  requestId = 0;
  requestParentId = 0;
  ...
  constructor(
    ...
    super(commentService, new ArticleCommentModel(), publicHelper, translate);
