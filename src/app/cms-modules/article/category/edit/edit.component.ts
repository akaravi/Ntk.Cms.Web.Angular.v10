...
import {
  ArticleCategoryModel, ArticleCategoryService, CoreEnumService,
...
export class ArticleCategoryEditComponent extends EditBaseComponent<ArticleCategoryService, ArticleCategoryModel, number>
  implements OnInit {
  requestId = 0;
  ...
  constructor(
    ...
    super(categoryService, new ArticleCategoryModel(), publicHelper, translate);
