...
export class ArticleCategoryDeleteComponent implements OnInit {
  requestId = 0;
  ...
  dataModelResultCategory: ErrorExceptionResult<ArticleCategoryModel> =
    new ErrorExceptionResult<ArticleCategoryModel>();
  dataModelResultCategoryAllData: ErrorExceptionResult<ArticleCategoryModel> =
    new ErrorExceptionResult<ArticleCategoryModel>();
  dataModel: any = {};
