...
@Component({
  selector: "app-sms-config-checkuser-mobile",
  templateUrl: "./check-user.mobile.component.html",
  styleUrls: ["./check-user.mobile.component.scss"],
  standalone: false,
})
export class SmsConfigCheckUserMobileComponent implements OnInit, OnDestroy {
  requestLinkUserId = 0;
