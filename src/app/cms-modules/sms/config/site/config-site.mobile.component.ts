...
@Component({
  selector: "app-sms-config-site-mobile",
  templateUrl: "./config-site.mobile.component.html",
  styleUrls: ["./config-site.mobile.component.scss"],
  standalone: false,
})
export class SmsConfigSiteMobileComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
