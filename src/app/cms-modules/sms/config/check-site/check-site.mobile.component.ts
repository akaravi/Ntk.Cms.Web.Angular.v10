...
@Component({
  selector: "app-sms-config-checksite-mobile",
  templateUrl: "./check-site.mobile.component.html",
  styleUrls: ["./check-site.mobile.component.scss"],
  standalone: false,
})
export class SmsConfigCheckSiteMobileComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
