...
export class SmsLogOutBoxDetailListMobileComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    this.requestLinkOutBoxId =
      this.activatedRoute.snapshot.paramMap.get("LinkOutBoxId");
    this.optionsSearch.parentMethods = {
      onSubmit: (model: Array<FilterDataModel>) =>
        this.onSubmitOptionsSearch(model),
    };
