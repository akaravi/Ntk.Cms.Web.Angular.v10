...
@Component({
  selector: "app-sms-log-outbox-detail-view-mobile",
  templateUrl: "./view.mobile.component.html",
  styleUrls: ["./view.mobile.component.scss"],
  standalone: false,
})
export class SmsLogOutBoxDetailViewMobileComponent
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SmsLogOutBoxDetailViewMobileComponent>,
  ...
  dataModelResult: ErrorExceptionResult<SmsLogOutBoxDetailModel> =
    new ErrorExceptionResult<SmsLogOutBoxDetailModel>();
