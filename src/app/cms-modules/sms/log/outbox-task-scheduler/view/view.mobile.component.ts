...
@Component({
  selector: "app-sms-log-outbox-task-scheduler-view-mobile",
  templateUrl: "./view.mobile.component.html",
  styleUrls: ["./view.mobile.component.scss"],
  standalone: false,
})
export class SmsLogOutBoxTaskSchedulerViewMobileComponent
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SmsLogOutBoxTaskSchedulerViewMobileComponent>,
  ...
  dataModelResult: ErrorExceptionResult<SmsLogOutBoxTaskSchedulerModel> =
    new ErrorExceptionResult<SmsLogOutBoxTaskSchedulerModel>();
  ...
  DataGetOneContent(): void {
    ...
    this.smsLogOutBoxTaskSchedulerService
