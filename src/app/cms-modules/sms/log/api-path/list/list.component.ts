...
import {
  CoreCurrencyModel,
  ErrorExceptionResult, FilterDataModel, FilterModel, RecordStatusEnum, SmsLogApiPathModel,
  SmsLogApiPathService, SmsMainApiPathModel, SmsMainApiPathService, SortTypeEnum
} from 'ntk-cms-api';
...
export class SmsLogApiPathListComponent extends ListBaseComponent<SmsLogApiPathService, SmsLogApiPathModel, string> implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    super(contentService, new SmsLogApiPathModel(), publicHelper, tokenHelper, translate);
