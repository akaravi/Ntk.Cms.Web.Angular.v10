...
@Component({
  selector: "app-sms-log-inbox-view-mobile",
  templateUrl: "./view.mobile.component.html",
  styleUrls: ["./view.mobile.component.scss"],
  standalone: false,
})
export class SmsLogInBoxViewMobileComponent implements OnInit, OnDestroy {
  requestId = "";
  constructorInfoAreaId = this.constructor.name;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<SmsLogInBoxViewMobileComponent>,
  ...
  dataModelResult: ErrorExceptionResult<SmsLogInBoxModel> =
    new ErrorExceptionResult<SmsLogInBoxModel>();
