...
export class SmsLogInBoxListComponent
  extends ListBaseComponent<SmsLogInBoxService, SmsLogInBoxModel, string>
  ...
  ngOnInit(): void {
    ...
    if (this.activatedRoute.snapshot.paramMap.get("LinkPrivateConfigId")) {
      this.requestLinkPrivateConfigId =
        this.activatedRoute.snapshot.paramMap.get("LinkPrivateConfigId");
    }
