...
import {
  CoreCurrencyModel,
  ErrorExceptionResult, FilterDataModel, FilterModel, RecordStatusEnum, SmsLogOutBoxQueueModel,
...
export class SmsLogOutBoxQueueListComponent extends ListBaseComponent<SmsLogOutBoxQueueService, SmsLogOutBoxQueueModel, string> implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    super(contentService, new SmsLogOutBoxQueueModel(), publicHelper, tokenHelper, translate);
