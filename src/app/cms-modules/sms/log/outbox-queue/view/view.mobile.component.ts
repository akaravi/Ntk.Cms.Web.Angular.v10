...
@Component({
  selector: "app-sms-log-outboxqueue-view-mobile",
  templateUrl: "./view.mobile.component.html",
  styleUrls: ["./view.mobile.component.scss"],
  standalone: false,
})
export class SmsLogOutBoxQueueViewMobileComponent
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SmsLogOutBoxQueueViewMobileComponent>,
  ...
  dataModelResult: ErrorExceptionResult<SmsLogOutBoxQueueModel> =
    new ErrorExceptionResult<SmsLogOutBoxQueueModel>();
