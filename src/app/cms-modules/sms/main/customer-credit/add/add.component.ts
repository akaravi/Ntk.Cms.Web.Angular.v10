...
export class SmsMainCustomerCreditAddComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    super(
      SmsMainCustomerCreditService,
      new SmsMainCustomerCreditModel(),
      publicHelper,
      translate,
    );
  ...
  dataModelResult: ErrorExceptionResult<SmsMainCustomerCreditModel> =
    new ErrorExceptionResult<SmsMainCustomerCreditModel>();
