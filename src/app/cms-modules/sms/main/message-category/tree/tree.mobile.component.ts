...
@Component({
  selector: "app-sms-main-message-category-tree-mobile",
  templateUrl: "./tree.mobile.component.html",
  styleUrls: ["./tree.mobile.component.scss"],
  standalone: false,
})
export class SmsMainMessageCategoryTreeMobileComponent
  implements OnInit, OnDestroy
{
  ...
  toggleNode(node: SmsMainMessageCategoryModel): void {
  ...
  isNodeExpanded(node: SmsMainMessageCategoryModel): boolean {
  ...
  renderTreeNodes(nodes: SmsMainMessageCategoryModel[]): void {
    // Helper method for rendering tree nodes recursively
  }
}
