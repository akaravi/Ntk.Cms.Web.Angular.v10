...
import {
  ...
  FormInfoModel,
  ManageUserAccessDataTypesEnum, SmsMainMessageCategoryModel, SmsMainMessageCategoryService
} from 'ntk-cms-api';
...
export class SmsMainMessageCategoryEditComponent extends EditBaseComponent<SmsMainMessageCategoryService, SmsMainMessageCategoryModel, string>
  implements OnInit {
  requestId = '';
