...
@Component({
  selector: "app-sms-apipath-add-mobile",
  templateUrl: "./add.mobile.component.html",
  styleUrls: ["./add.mobile.component.scss"],
  standalone: false,
})
export class SmsMainApiPathAddMobileComponent
  extends AddBaseComponent<SmsMainApiPathService, SmsMainApiPathModel, string>
  implements OnInit
{
  requestId = "";
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SmsMainApiPathAddMobileComponent>,
  ...
  onActionSelectorSelectLinkApiPathCompanyId(
    model: SmsMainApiPathCompanyModel | null,
  ): void {
  ...
  onFormSubmit(): void {
    ...
    if (
      !this.dataModel.linkApiPathCompanyId ||
      this.dataModel.linkApiPathCompanyId.length == 0
    ) {
      this.translate
        .get("MESSAGE.Service_company_is_not_clear")
        .subscribe((message: string) => {
