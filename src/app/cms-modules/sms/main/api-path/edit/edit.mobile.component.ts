...
export class SmsMainApiPathEditMobileComponent
  extends EditBaseComponent<SmsMainApiPathService, SmsMainApiPathModel, string>
  implements OnInit
{
  requestId = "";
  ...
  DataGetOneContent(): void {
    ...
    this.smsMainApiPathService.setAccessDataType(
