...
import {
  FilterDataModel, FilterModel, RecordStatusEnum, SmsMainApiPathCompanyModel,
  SmsMainApiPathCompanyService, SortTypeEnum
} from 'ntk-cms-api';
...
export class SmsMainApiPathCompanyListComponent extends ListBaseComponent<SmsMainApiPathCompanyService, SmsMainApiPathCompanyModel, string> implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    super(contentService, new SmsMainApiPathCompanyModel(), publicHelper, tokenHelper, translate);
