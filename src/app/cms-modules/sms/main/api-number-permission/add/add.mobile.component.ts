...
export class SmsMainApiNumberPermissionAddMobileComponent
  ...
  implements OnInit
{
  ...
  dataModelResult: ErrorExceptionResult<SmsMainApiNumberPermissionModel> =
    new ErrorExceptionResult<SmsMainApiNumberPermissionModel>();
