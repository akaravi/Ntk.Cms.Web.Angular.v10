...
@Component({
  selector: "app-sms-api-number-permission-edit-mobile",
  templateUrl: "./edit.mobile.component.html",
  styleUrls: ["./edit.mobile.component.scss"],
  standalone: false,
})
export class SmsMainApiNumberPermissionEditMobileComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SmsMainApiNumberPermissionEditMobileComponent>,
