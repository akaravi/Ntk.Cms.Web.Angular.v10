...
import { SmsMainClientApplicationPermissionAddComponent } from "../add/add.component";
import { SmsMainClientApplicationPermissionEditComponent } from "../edit/edit.component";

@Component({
  selector: "app-sms-client-application-permission-list",
  templateUrl: "./list.component.html",
  standalone: false,
})
export class SmsMainClientApplicationPermissionListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  tableData: SmsMainClientApplicationPermissionModel[] = [];
  requestLinkClientApplicationId = "";
  requestLinkApiPathId = "";
  constructorInfoAreaId = this.constructor.name;
  constructor(
    public contentService: SmsMainClientApplicationPermissionService,
  ...
  expandedElement: SmsMainClientApplicationPermissionModel | null;
  ...
  onActionButtonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(
      SmsMainClientApplicationPermissionAddComponent,
      {
        ...
        data: {
          LinkClientApplicationId: this.requestLinkClientApplicationId,
          LinkApiPathId: this.requestLinkApiPathId,
        },
      },
    );
