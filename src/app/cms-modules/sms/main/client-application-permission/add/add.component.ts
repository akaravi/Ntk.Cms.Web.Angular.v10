...
export class SmsMainClientApplicationPermissionAddComponent
  ...
  implements OnInit
{
  ...
  dataModelResult: ErrorExceptionResult<SmsMainClientApplicationPermissionModel> =
