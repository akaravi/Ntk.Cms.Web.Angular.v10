...
@Component({
  selector: "app-sms-apipath-pagination-add-mobile",
  templateUrl: "./add.mobile.component.html",
  styleUrls: ["./add.mobile.component.scss"],
  standalone: false,
})
export class SmsMainApiPathPaginationAddMobileComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SmsMainApiPathPaginationAddMobileComponent>,
