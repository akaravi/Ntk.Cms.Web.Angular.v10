...
@Component({
  selector: "app-sms-client-add-mobile",
  templateUrl: "./add.mobile.component.html",
  styleUrls: ["./add.mobile.component.scss"],
  standalone: false,
})
export class SmsMainClientPermissionAddMobileComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SmsMainClientPermissionAddMobileComponent>,
  ...
  dataModelResult: ErrorExceptionResult<SmsMainClientPermissionModel> =
    new ErrorExceptionResult<SmsMainClientPermissionModel>();
  ...
  DataAddContent(): void {
    ...
    this.smsMainClientPermissionService.ServiceAdd(this.dataModel).subscribe({
      next: (ret) => {
