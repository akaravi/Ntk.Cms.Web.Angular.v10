...
@Component({
  selector: "app-sms-main-message-content-edit-mobile",
  templateUrl: "./edit.mobile.component.html",
  styleUrls: ["./edit.mobile.component.scss"],
  standalone: false,
})
export class SmsMainMessageContentEditMobileComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SmsMainMessageContentEditMobileComponent>,
  ...
  DataGetOneContent(): void {
    ...
    this.SmsMainMessageContentService.setAccessDataType(
      ManageUserAccessDataTypesEnum.Editor,
    );
    this.SmsMainMessageContentService.ServiceGetOneById(
      this.requestId,
    ).subscribe({
      next: (ret) => {
