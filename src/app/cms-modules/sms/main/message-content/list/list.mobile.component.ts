  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    this.requestLinkCategoryId =
      this.activatedRoute.snapshot.paramMap.get("LinkCategoryId");
  ...
  categoryModelSelected: SmsMainMessageCategoryModel =
  ...
  onActionButtonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(SmsMainMessageContentAddComponent, {
      height: "90%",
      panelClass: panelClass,
      data: {
        linkCategoryId: this.requestLinkCategoryId,
      },
    });
  ...
  onActionButtonEditRow(
    ...
    const dialogRef = this.dialog.open(SmsMainMessageContentEditComponent, {
      height: "90%",
      panelClass: panelClass,
