...
@Component({
  selector: "app-sms-apipathpermission-add-mobile",
  templateUrl: "./add.mobile.component.html",
  styleUrls: ["./add.mobile.component.scss"],
  standalone: false,
})
export class SmsMainApiPathPermissionAddMobileComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SmsMainApiPathPermissionAddMobileComponent>,
  ...
  dataModelResult: ErrorExceptionResult<SmsMainApiPathPermissionModel> =
    new ErrorExceptionResult<SmsMainApiPathPermissionModel>();
  ...
  dataModelEnumApiPathPermissionActionResult: ErrorExceptionResult<InfoEnumModel> =
    new ErrorExceptionResult<InfoEnumModel>();
