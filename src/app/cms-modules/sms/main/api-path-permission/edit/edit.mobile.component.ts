...
@Component({
  selector: "app-sms-apipathpermission-edit-mobile",
  templateUrl: "./edit.mobile.component.html",
  styleUrls: ["./edit.mobile.component.scss"],
  standalone: false,
})
export class SmsMainApiPathPermissionEditMobileComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SmsMainApiPathPermissionEditMobileComponent>,
  ...
  DataGetOneContent(): void {
    ...
    this.smsMainApiPathPermissionService.setAccessDataType(
