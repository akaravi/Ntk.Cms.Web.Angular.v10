...
@Component({
  selector: "app-core-log-sms-view-mobile",
  templateUrl: "./view.mobile.component.html",
  styleUrls: ["./view.mobile.component.scss"],
  standalone: false,
})
export class CoreLogSmsViewMobileComponent implements OnInit, OnDestroy {
  requestId = "";
  constructorInfoAreaId = this.constructor.name;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<CoreLogSmsViewMobileComponent>,
