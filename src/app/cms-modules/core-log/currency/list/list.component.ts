...
export class CoreLogCurrencyListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    this.requestLinkCurrencyId = +Number(
      this.activatedRoute.snapshot.paramMap.get("LinkCurrencyId"),
    );
  ...
  onActionButtonViewRow(
    model: CoreLogCurrencyModel = this.tableRowSelected,
  ): void {
