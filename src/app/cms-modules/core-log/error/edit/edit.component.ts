...
export class CoreLogErrorEditComponent
  extends EditBaseComponent<CoreLogErrorService, CoreLogErrorModel, string>
  implements OnInit, OnDestroy
{
  ...
  dataModelResult: ErrorExceptionResult<CoreLogErrorModel> =
    new ErrorExceptionResult<CoreLogErrorModel>();
