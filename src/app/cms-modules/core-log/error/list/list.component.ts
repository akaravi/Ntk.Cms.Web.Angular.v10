...
export class CoreLogErrorListComponent
  extends ListBaseComponent<CoreLogErrorService, CoreLogErrorModel, string>
  implements OnInit, OnDestroy
{
  ...
  onActionButtonEditRow(
    model: CoreLogErrorModel = this.tableRowSelected,
  ): void {
