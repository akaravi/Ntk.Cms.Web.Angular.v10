...
export class CoreLogEmailListComponent
  extends ListBaseComponent<CoreLogEmailService, CoreLogEmailModel, string>
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    public contentService: CoreLogEmailService,
  ...
  onActionButtonViewRow(
    model: CoreLogEmailModel = this.tableRowSelected,
  ): void {
  ...
  onActionButtonViewMemberRow(
    ...
    if (
      ...
      this.translate
        .get("MESSAGE.content_does_not_include_member_informations")
        .subscribe((str: string) => {
          this.cmsToastrService.typeErrorSelected(str);
        });
      return;
