...
import {
  CoreEnumService, CoreLogEmailModel, CoreLogEmailService, DataFieldInfoModel, ErrorExceptionResult,
...
@Component({
  selector: 'app-core-log-email-view',
  templateUrl: './view.component.html',
  standalone: false
})
export class CoreLogEmailViewComponent implements OnInit, OnDestroy {
  requestId = '';
  constructorInfoAreaId = this.constructor.name;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<CoreLogEmailViewComponent>,
