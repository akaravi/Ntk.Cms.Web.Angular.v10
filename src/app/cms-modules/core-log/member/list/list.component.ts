...
export class CoreLogMemberListComponent
  extends ListBaseComponent<CoreLogMemberService, CoreLogMemberModel, string>
  implements OnInit, OnDestroy
{
  ...
  onActionButtonViewRow(
    model: CoreLogMemberModel = this.tableRowSelected,
  ): void {
  ...
  onActionButtonViewUserRow(
    ...
    this.onActionTableRowSelect(model);
    if (
      !this.tableRowSelected.linkCoreUserId ||
      this.tableRowSelected.linkCoreUserId === 0
    ) {
      this.translate
