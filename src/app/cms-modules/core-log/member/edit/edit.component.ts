...
export class CoreLogMemberEditComponent
  extends EditBaseComponent<CoreLogMemberService, CoreLogMemberModel, string>
  implements OnInit, OnDestroy
{
  ...
  DataGetOneContent(): void {
    ...
    this.coreLogMemberService.setAccessDataType(
