...
@Component({
  selector: "app-core-log-notification-view",
  templateUrl: "./view.component.html",
  standalone: false,
})
export class CoreLogNotificationViewComponent implements OnInit, OnDestroy {
  requestId = "";
  constructorInfoAreaId = this.constructor.name;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<CoreLogNotificationViewComponent>,
  ...
  dataModelResult: ErrorExceptionResult<CoreLogNotificationModel> =
    new ErrorExceptionResult<CoreLogNotificationModel>();
  ...
  DataGetOneContent(): void {
    ...
    this.coreLogNotificationService
