...
export class CoreLogNotificationListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    public contentService: CoreLogNotificationService,
  ...
  onActionButtonViewRow(
    model: CoreLogNotificationModel = this.tableRowSelected,
  ): void {
