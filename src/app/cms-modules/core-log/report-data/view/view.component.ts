...
@Component({
  selector: "app-core-log-report-data-view",
  templateUrl: "./view.component.html",
  standalone: false,
})
export class CoreLogReportDataViewComponent implements OnInit, OnDestroy {
  requestId = "";
  ...
  dataModelResult: ErrorExceptionResult<CoreLogReportDataModel> =
    new ErrorExceptionResult<CoreLogReportDataModel>();
