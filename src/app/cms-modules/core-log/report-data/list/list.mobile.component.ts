...
import { CoreLogReportDataListComponent } from "./list.component";

@Component({
  selector: "app-core-log-report-data-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class CoreLogReportDataListMobileComponent extends CoreLogReportDataListComponent {
