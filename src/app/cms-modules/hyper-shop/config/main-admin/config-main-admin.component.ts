...
import {AccessModel,
  CoreEnumService,
  DataFieldInfoModel,HyperShopConfigurationService,
...
export class HyperShopConfigMainAdminComponent implements OnInit, OnDestroy {
  ...
  dataConfigSiteAccessValuesDefaultModel =
    new HyperShopModuleConfigSiteAccessValuesModel();
  dataConfigAdminMainModel = new HyperShopModuleConfigAdminMainValuesModel();
