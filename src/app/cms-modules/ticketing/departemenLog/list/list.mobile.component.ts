...
import { TicketingDepartemenLogListComponent } from "./list.component";
...
export class TicketingDepartemenLogListMobileComponent extends TicketingDepartemenLogListComponent {
