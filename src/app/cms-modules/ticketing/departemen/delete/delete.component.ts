...
import {DataFieldInfoModel,
  ...
  TicketingDepartemenService} from "ntk-cms-api";
...
export class TicketingDepartemenDeleteComponent implements OnInit {
  ...
  dataModelResultCategory: ErrorExceptionResult<TicketingDepartemenModel> =
    new ErrorExceptionResult<TicketingDepartemenModel>();
  dataModelResultCategoryAllData: ErrorExceptionResult<TicketingDepartemenModel> =
    new ErrorExceptionResult<TicketingDepartemenModel>();
  dataModel: any = {};
  ...
  DataGetOne(): void {
    ...
    this.ticketingDepartemenService.setAccessDataType(
  ...
  onFormDelete(): void {
    ...
    this.ticketingDepartemenService.ServiceDelete(this.requestId).subscribe({
      next: (ret) => {
