...
export class TicketingFaqListComponent
  extends ListBaseComponent<TicketingFaqService, TicketingFaqModel, number>
  implements OnInit, OnDestroy
{
  ...
  onActionButtonDeleteRow(
    mode: TicketingFaqModel = this.tableRowSelected,
  ): void {
    ...
    this.translate
      ...
      .subscribe((str: string) => {
        ...
        message =
          ...
          "?" +
          "<br> ( " +
          this.tableRowSelected.question +
          " ) ";
      });
