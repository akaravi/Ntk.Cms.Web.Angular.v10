...
export class TicketingFaqEditComponent
  extends EditBaseComponent<TicketingFaqService, TicketingFaqModel, number>
  implements OnInit
{
  requestId = 0;
  ...
  DataGetOneContent(): void {
    ...
    this.ticketingFaqService.setAccessDataType(
      ...
      next: (ret) => {
        ...
        if (ret.isSuccess) {
          this.formInfo.formTitle =
            this.formInfo.formTitle + " " + ret.item.question;
          this.formInfo.submitResultMessage = "";
