...
import {
    ...
    CoreEnumService,
    DataFieldInfoModel,
    ErrorExceptionResult, TicketingAnswerModel,
...
export class TicketingAnswerAddComponent
  extends AddBaseComponent<TicketingAnswerService, TicketingAnswerModel, number>
  implements OnInit
{
  requestLinkTaskId = 0;
  ...
  dataModelResult: ErrorExceptionResult<TicketingAnswerModel> =
    new ErrorExceptionResult<TicketingAnswerModel>();
