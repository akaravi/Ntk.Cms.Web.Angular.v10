...
export class TicketingAnswerEditComponent
  ...
  implements OnInit
{
  ...
  DataGetOne(requestId: number): void {
    ...
    this.ticketingAnswerService.setAccessDataType(
      ManageUserAccessDataTypesEnum.Editor,
    );
    this.ticketingAnswerService.ServiceGetOneById(requestId).subscribe({
      next: (ret) => {
        /*َAccess Field*/
