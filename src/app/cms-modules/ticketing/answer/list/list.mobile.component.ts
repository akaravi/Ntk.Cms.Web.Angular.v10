...
import { TicketingAnswerListComponent } from "./list.component";

@Component({
  selector: "app-ticketing-answer-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class TicketingAnswerListMobileComponent extends TicketingAnswerListComponent {
