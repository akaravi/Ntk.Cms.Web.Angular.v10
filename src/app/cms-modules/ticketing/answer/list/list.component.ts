...
export class TicketingAnswerListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  dataModelEnumAnswerStatusResult: ErrorExceptionResult<InfoEnumModel> =
  ...
  ngOnInit(): void {
    this.requestLinkTaskId = +Number(
      this.activatedRoute.snapshot.paramMap.get("LinkTaskId"),
    );
  ...
  onActionButtonNewRow(): void {
    if (
      ...
      (this.requestLinkTaskId == null || this.requestLinkTaskId === 0)
    ) {
      this.translate
  ...
  onActionButtonViewRow(
    mode: TicketingAnswerModel = this.tableRowSelected,
  ): void {
