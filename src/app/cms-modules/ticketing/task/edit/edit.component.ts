...
export class TicketingTaskEditComponent
  extends EditBaseComponent<TicketingTaskService, TicketingTaskModel, number>
  implements OnInit
{
  requestId = 0;
  ...
  DataGetOne(requestId: number): void {
    ...
    this.ticketingTaskService.setAccessDataType(
      ManageUserAccessDataTypesEnum.Editor,
    );
    this.ticketingTaskService.ServiceGetOneById(requestId).subscribe({
      next: (ret) => {
        /*َAccess Field*/
  ...
  DataEditContent(): void {
    ...
    this.ticketingTaskService.ServiceEdit(this.dataModel).subscribe({
      next: (ret) => {
