...
export class TicketingTaskListComponent
  extends ListBaseComponent<TicketingTaskService, TicketingTaskModel, number>
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    /*filter Sort*/
    this.filteModelContent.sortColumn = "updatedDate";
  ...
  ngOnInit(): void {
    ...
    if (this.activatedRoute.snapshot.paramMap.get("TicketStatus"))
      this.requestTicketStatus = +Number(
        this.activatedRoute.snapshot.paramMap.get("TicketStatus"),
      );
