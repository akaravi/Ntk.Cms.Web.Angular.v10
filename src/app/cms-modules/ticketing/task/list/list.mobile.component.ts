...
import { TicketingTaskListComponent } from "./list.component";

@Component({
  selector: "app-ticketing-task-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class TicketingTaskListMobileComponent extends TicketingTaskListComponent {
