...
export class DonateLogViewListComponent
  extends ListBaseComponent<DonateLogViewService, DonateLogViewModel, string>
  implements OnInit, OnDestroy
{
  ...
  onActionButtonViewRow(
    model: DonateLogViewModel = this.tableRowSelected,
  ): void {
