...
@Component({
  selector: "app-donate-target-period-sponser-delete",
  templateUrl: "./delete.component.html",
  standalone: false,
})
export class DonateTargetPeriodSponserDeleteComponent implements OnInit {
  requestId = 0;
  ...
  dataModelResultContent: ErrorExceptionResult<DonateTargetPeriodSponsorModel> =
  ...
  DataGetOne(): void {
    ...
    this.donateTargetPeriodSponsorService.setAccessDataType(
