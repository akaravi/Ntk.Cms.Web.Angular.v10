...
import {
  CoreEnumService,
  DonateSponsorModel, DonateSponsorService, DonateTargetCategoryModel,
...
export class DonateSponserEditComponent extends EditBaseComponent<DonateSponsorService, DonateSponsorModel, number>
  implements OnInit {
  requestId = 0;
