...
@Component({
  selector: "app-donate-sponser-delete",
  templateUrl: "./delete.component.html",
  standalone: false,
})
export class DonateSponserDeleteComponent implements OnInit {
  requestId = 0;
  ...
  dataModelResultContent: ErrorExceptionResult<DonateSponsorModel> =
  ...
  DataGetOne(): void {
    ...
    this.donateSponsorService.setAccessDataType(
  ...
  onFormDelete(): void {
    ...
    this.donateSponsorService.ServiceDelete(this.requestId).subscribe({
      next: (ret) => {
