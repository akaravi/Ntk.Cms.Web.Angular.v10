...
import { DonateConfigCheckSiteComponent } from "./config/check-site/check-site.component";
import { DonateConfigCheckUserComponent } from "./config/check-user/check-user.component";
import { DonateConfigComponent } from "./config/donate-config.component";
