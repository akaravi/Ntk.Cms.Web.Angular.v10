...
import {
  CoreEnumService,
  DonateTargetCategoryModel, DonateTargetModel, DonateTargetService,
...
export class DonateTargetEditComponent extends EditBaseComponent<DonateTargetService, DonateTargetModel, number>
  implements OnInit {
  requestId = 0;
