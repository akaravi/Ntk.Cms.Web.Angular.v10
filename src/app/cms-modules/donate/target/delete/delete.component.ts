...
export class DonateTargetDeleteComponent implements OnInit {
  ...
  dataModelResultContent: ErrorExceptionResult<DonateTargetModel> =
  ...
  DataGetOne(): void {
    ...
    this.donateTargetService.setAccessDataType(
  ...
  onFormDelete(): void {
    ...
    this.donateTargetService.ServiceDelete(this.requestId).subscribe({
      next: (ret) => {
