...
export class DonateTargetCategoryDeleteComponent implements OnInit {
  ...
  dataModelResultCategory: ErrorExceptionResult<DonateTargetCategoryModel> =
    new ErrorExceptionResult<DonateTargetCategoryModel>();
  dataModelResultCategoryAllData: ErrorExceptionResult<DonateTargetCategoryModel> =
    new ErrorExceptionResult<DonateTargetCategoryModel>();
  dataModel: any = {};
  ...
  DataGetOne(): void {
    ...
    this.donateTargetCategoryService.setAccessDataType(
  ...
  DataGetAll(): void {
    ...
    this.donateTargetCategoryService.ServiceGetAll(filterModel).subscribe({
      next: (ret) => {
  ...
  onFormDelete(): void {
    ...
    this.donateTargetCategoryService.ServiceDelete(this.requestId).subscribe({
      next: (ret) => {
