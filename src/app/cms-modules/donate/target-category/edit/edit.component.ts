...
import {
  CoreEnumService,
  DonateTargetCategoryModel, DonateTargetCategoryService,
...
export class DonateTargetCategoryEditComponent extends EditBaseComponent<DonateTargetCategoryService, DonateTargetCategoryModel, number>
  implements OnInit {
  requestId = 0;
