...
export class DonateTargetCategorySelectorComponent implements OnInit {
  static nextId = 0;
  id = ++DonateTargetCategorySelectorComponent.nextId;
  ...
  ): Promise<DonateTargetCategoryModel[]> {
  ...
  push(
    newvalue: DonateTargetCategoryModel,
  ): Observable<DonateTargetCategoryModel[]> {
