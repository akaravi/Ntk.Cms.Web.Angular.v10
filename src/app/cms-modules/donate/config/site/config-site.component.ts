...
import {AccessModel,
  ...
  DonateModuleSiteStorageValuesModel,TokenInfoModelV3} from "ntk-cms-api";
...
export class DonateConfigSiteComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  ...
  dataConfigSiteAccessValuesModel =
    new DonateModuleConfigSiteAccessValuesModel();
