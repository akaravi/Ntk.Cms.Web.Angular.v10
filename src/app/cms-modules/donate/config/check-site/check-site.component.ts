...
import {
  BaseModuleSiteCheckSiteModel, CoreEnumService, DonateConfigurationService, ErrorExceptionResult,
  TokenInfoModelV3
} from 'ntk-cms-api';
...
@Component({
    selector: 'app-donate-config-checksite',
    templateUrl: './check-site.component.html',
    standalone: false
})
export class DonateConfigCheckSiteComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
