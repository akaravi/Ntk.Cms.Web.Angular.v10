...
export class DonateTargetPeriodSelectorComponent implements OnInit {
  ...
  dataModelResult: ErrorExceptionResult<DonateTargetPeriodModel> =
  ...
  ): Promise<DonateTargetPeriodModel[]> {
  ...
  push(
    newvalue: DonateTargetPeriodModel,
  ): Observable<DonateTargetPeriodModel[]> {
