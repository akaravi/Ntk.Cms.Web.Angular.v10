...
export class DonateTargetPeriodDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<DonateTargetPeriodDeleteComponent>,
    public publicHelper: PublicHelper,
    private donateTargetPeriodService: DonateTargetPeriodService,
  ...
  dataModelResultContent: ErrorExceptionResult<DonateTargetPeriodModel> =
    new ErrorExceptionResult<DonateTargetPeriodModel>();
  ...
  DataGetOne(): void {
    ...
    this.donateTargetPeriodService.setAccessDataType(
  ...
  onFormDelete(): void {
    ...
    this.donateTargetPeriodService.ServiceDelete(this.requestId).subscribe({
      next: (ret) => {
