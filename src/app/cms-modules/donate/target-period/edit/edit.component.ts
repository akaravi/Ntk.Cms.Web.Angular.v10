...
import {
  CoreEnumService,
  DonateTargetCategoryModel, DonateTargetPeriodModel, DonateTargetPeriodService,
...
export class DonateTargetPeriodEditComponent extends EditBaseComponent<DonateTargetPeriodService, DonateTargetPeriodModel, number>
  implements OnInit {
  requestId = 0;
