...
import {
  ...
  FormInfoModel,
  LinkManagementCategoryModel, LinkManagementCategoryService
} from 'ntk-cms-api';
...
export class LinkManagementCategoryAddComponent extends AddBaseComponent<LinkManagementCategoryService, LinkManagementCategoryModel, number> implements OnInit {
  requestParentId = 0;
