...
import {
  ...
  FormInfoModel,
  LinkManagementCategoryModel, LinkManagementCategoryService, ManageUserAccessDataTypesEnum
} from 'ntk-cms-api';
...
export class LinkManagementCategoryEditComponent extends EditBaseComponent<LinkManagementCategoryService, LinkManagementCategoryModel, number>
  implements OnInit {
  requestId = 0;
  ...
  constructor(
    ...
    super(categoryService, new LinkManagementCategoryModel(), publicHelper, translate);
