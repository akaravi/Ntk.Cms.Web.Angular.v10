...
import {
    ...
    FilterModel, LinkManagementCategoryModel,
...
export class LinkManagementCategoryDeleteComponent implements OnInit {
  ...
  dataModelResultCategory: ErrorExceptionResult<LinkManagementCategoryModel> =
    new ErrorExceptionResult<LinkManagementCategoryModel>();
  dataModelResultCategoryAllData: ErrorExceptionResult<LinkManagementCategoryModel> =
    new ErrorExceptionResult<LinkManagementCategoryModel>();
  dataModel: any = {};
