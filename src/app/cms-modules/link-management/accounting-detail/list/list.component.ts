...
export class LinkManagementAccountingDetailListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    this.requestLinkManagementAccountingId = +Number(
      this.activatedRoute.snapshot.paramMap.get("LinkManagementAccountingId"),
    );
