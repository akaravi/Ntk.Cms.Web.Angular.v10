...
import {CoreEnumService,
  ...
  LinkManagementEnumService} from "ntk-cms-api";
...
export class LinkManagementAccountingDetailAddComponent
  ...
  implements OnInit
{
  ...
  dataModelResult: ErrorExceptionResult<LinkManagementAccountingDetailModel> =
  ...
  onActionSelectorAccount(model: LinkManagementAccountingModel | null): void {
    if (!model || !model.id || model.id <= 0) {
      this.translate
        .get("MESSAGE.Account_information_is_not_clear")
        .subscribe((str: string) => {
