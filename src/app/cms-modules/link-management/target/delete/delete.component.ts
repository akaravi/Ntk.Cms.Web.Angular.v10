...
import {DataFieldInfoModel,
  ErrorExceptionResult,LinkManagementTargetModel,
...
export class LinkManagementTargetDeleteComponent implements OnInit {
  ...
  dataModelResultContent: ErrorExceptionResult<LinkManagementTargetModel> =
  ...
  DataGetOne(): void {
    ...
    this.linkManagementTargetService.setAccessDataType(
