...
export class LinkManagementTargetAddComponent
  ...
  implements OnInit
{
  ...
  dataModelResult: ErrorExceptionResult<LinkManagementTargetModel> =
  ...
  DataAddContent(): void {
    ...
    this.linkManagementTargetService.ServiceAdd(this.dataModel).subscribe({
      next: (ret) => {
        this.publicHelper.processService.processStop(pName);
