...
import {
  ...
  ErrorExceptionResult, LinkManagementConfigurationService, TokenInfoModelV3
} from 'ntk-cms-api';
...
export class LinkManagementConfigCheckSiteComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
