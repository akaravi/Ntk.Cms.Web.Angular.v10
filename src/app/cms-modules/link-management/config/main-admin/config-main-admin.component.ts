...
export class LinkManagementConfigMainAdminComponent
  implements OnInit, OnDestroy
{
  ...
  dataConfigSiteValuesDefaultModel =
    new LinkManagementModuleConfigSiteValuesModel();
  dataConfigSiteAccessValuesDefaultModel =
    new LinkManagementModuleConfigSiteAccessValuesModel();
  dataConfigAdminMainModel =
    new LinkManagementModuleConfigAdminMainValuesModel();
