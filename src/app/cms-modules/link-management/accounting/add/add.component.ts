...
import {CoreEnumService,
  DataFieldInfoModel,
  ErrorExceptionResult,LinkManagementAccountingModel,
  LinkManagementAccountingService,
  LinkManagementMemberModel} from "ntk-cms-api";
...
export class LinkManagementAccountingAddComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    super(
      categoryService,
      new LinkManagementAccountingModel(),
      publicHelper,
      translate,
    );
  ...
  dataModelResult: ErrorExceptionResult<LinkManagementAccountingModel> =
    new ErrorExceptionResult<LinkManagementAccountingModel>();
  dataModel: LinkManagementAccountingModel =
    new LinkManagementAccountingModel();
