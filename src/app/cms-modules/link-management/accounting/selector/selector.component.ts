...
export class LinkManagementAccountingSelectorComponent implements OnInit {
  ...
  dataModelSelect: LinkManagementAccountingModel =
  ...
  ): Promise<LinkManagementAccountingModel[]> {
  ...
  push(
    newvalue: LinkManagementAccountingModel,
  ): Observable<LinkManagementAccountingModel[]> {
