...
import {CoreEnumService,
  ...
  LinkManagementMemberService} from "ntk-cms-api";
...
export class LinkManagementMemberAddComponent
  ...
  implements OnInit
{
  ...
  dataModelResult: ErrorExceptionResult<LinkManagementMemberModel> =
  ...
  onActionSelectorCmsUser(model: CoreUserModel | null): void {
    if (!model || !model.id || model.id <= 0) {
      this.translate
        .get("MESSAGE.Information_user_is_not_clear")
        .subscribe((str: string) => {
