...
export class LinkManagementMemberSelectorComponent implements OnInit {
  static nextId = 0;
  id = ++LinkManagementMemberSelectorComponent.nextId;
  ...
  ): Promise<LinkManagementMemberModel[]> {
  ...
  push(
    newvalue: LinkManagementMemberModel,
  ): Observable<LinkManagementMemberModel[]> {
