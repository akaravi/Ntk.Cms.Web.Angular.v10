...
import {DataFieldInfoModel,
  ErrorExceptionResult,LinkManagementMemberModel,
...
export class LinkManagementMemberDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<LinkManagementMemberDeleteComponent>,
  ...
  dataModelResultContent: ErrorExceptionResult<LinkManagementMemberModel> =
    new ErrorExceptionResult<LinkManagementMemberModel>();
  ...
  DataGetOne(): void {
    ...
    this.linkManagementMemberService.setAccessLoad();
    this.linkManagementMemberService.setAccessDataType(
      ManageUserAccessDataTypesEnum.Editor,
    );
    this.linkManagementMemberService
  ...
  onFormDelete(): void {
    ...
    this.linkManagementMemberService.ServiceDelete(this.requestId).subscribe({
      next: (ret) => {
