...
import {DataFieldInfoModel,
  ...
  FilterModel,LinkManagementBillboardPatternModel,
...
export class LinkManagementBillboardPatternDeleteComponent implements OnInit {
  ...
  dataModelResultCategory: ErrorExceptionResult<LinkManagementBillboardPatternModel> =
    new ErrorExceptionResult<LinkManagementBillboardPatternModel>();
  dataModelResultCategoryAllData: ErrorExceptionResult<LinkManagementBillboardPatternModel> =
    new ErrorExceptionResult<LinkManagementBillboardPatternModel>();
  dataModel: any = {};
