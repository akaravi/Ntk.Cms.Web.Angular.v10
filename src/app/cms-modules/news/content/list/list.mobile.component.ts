...
import { NewsContentListComponent } from "./list.component";

@Component({
  selector: "app-news-content-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class NewsContentListMobileComponent extends NewsContentListComponent {
