...
export class NewsContentEditComponent
  extends EditBaseComponent<NewsContentService, NewsContentModel, number>
  implements OnInit
{
  requestId = 0;
  ...
  dataContentTagModelResult: ErrorExceptionResult<NewsContentTagModel> =
    new ErrorExceptionResult<NewsContentTagModel>();
  dataContentSimilarModelResult: ErrorExceptionResult<NewsContentSimilarModel> =
    new ErrorExceptionResult<NewsContentSimilarModel>();
  dataContentOtherInfoModelResult: ErrorExceptionResult<NewsContentOtherInfoModel> =
    new ErrorExceptionResult<NewsContentOtherInfoModel>();
  ...
  otherInfoTabledataSource =
    new MatTableDataSource<NewsContentOtherInfoModel>();
