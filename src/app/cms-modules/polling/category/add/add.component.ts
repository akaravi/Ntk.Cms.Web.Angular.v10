...
import {CoreEnumService,
  DataFieldInfoModel,
  ErrorExceptionResult,PollingCategoryModel,
...
export class PollingCategoryAddComponent
  extends AddBaseComponent<PollingCategoryService, PollingCategoryModel, number>
  implements OnInit
{
  requestParentId = 0;
  ...
  dataModelResult: ErrorExceptionResult<PollingCategoryModel> =
