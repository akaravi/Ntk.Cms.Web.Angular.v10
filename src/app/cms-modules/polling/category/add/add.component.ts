...
import {
  ...
  FormInfoModel,
  PollingCategoryModel, PollingCategoryService
} from 'ntk-cms-api';
...
export class PollingCategoryAddComponent extends AddBaseComponent<PollingCategoryService, PollingCategoryModel, number> implements OnInit {
  requestParentId = 0;
