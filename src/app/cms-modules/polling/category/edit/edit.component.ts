...
import {
  ...
  FormInfoModel,
  ManageUserAccessDataTypesEnum, PollingCategoryModel, PollingCategoryService
} from 'ntk-cms-api';
...
export class PollingCategoryEditComponent extends EditBaseComponent<PollingCategoryService, PollingCategoryModel, number>
  implements OnInit {
  requestId = 0;
  ...
  constructor(
    ...
    super(pollingCategoryService, new PollingCategoryModel(), publicHelper, translate);
