...
export class PollingCategoryDeleteComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<PollingCategoryDeleteComponent>,
  ...
  dataModelResultCategory: ErrorExceptionResult<PollingCategoryModel> =
    new ErrorExceptionResult<PollingCategoryModel>();
  dataModelResultCategoryAllData: ErrorExceptionResult<PollingCategoryModel> =
    new ErrorExceptionResult<PollingCategoryModel>();
  dataModel: any = {};
  ...
  DataGetOne(): void {
    ...
    this.pollingCategoryService.setAccessDataType(
  ...
  DataGetAll(): void {
    ...
    this.pollingCategoryService.ServiceGetAll(filterModel).subscribe({
      next: (ret) => {
  ...
  onFormDelete(): void {
    ...
    this.pollingCategoryService.ServiceDelete(this.requestId).subscribe({
      next: (ret) => {
  ...
  onFormChangeNewCatId(model: PollingCategoryModel): void {
    this.formInfo.submitResultMessage = "";
