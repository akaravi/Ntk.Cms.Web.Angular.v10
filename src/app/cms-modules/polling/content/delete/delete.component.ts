...
import {DataFieldInfoModel,
  ...
  PollingContentModel,
  PollingContentService} from "ntk-cms-api";
...
export class PollingContentDeleteComponent implements OnInit {
  ...
  dataModelResultContent: ErrorExceptionResult<PollingContentModel> =
  ...
  onFormDelete(): void {
    ...
    this.pollingContentService.ServiceDelete(this.requestId).subscribe({
      next: (ret) => {
