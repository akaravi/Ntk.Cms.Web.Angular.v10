...
import {CoreEnumService,
  ...
  PollingVoteModel,
  PollingVoteService} from "ntk-cms-api";
...
export class PollingVoteEditComponent
  extends EditBaseComponent<PollingVoteService, PollingVoteModel, string>
  implements OnInit
{
  requestId = "";
  requestParentId = 0;
  ...
  DataGetOneContent(): void {
    ...
    this.pollingVoteService.setAccessDataType(
