...
import { CrmCampaignAddComponent } from "../add/add.component";
import { CrmCampaignEditComponent } from "../edit/edit.component";

/**
 * Component لیست Campaignهای CRM.
 * این component لیست تمام Campaignهای موجود را نمایش می‌دهد و امکان افزودن، ویرایش و حذف را فراهم می‌کند.
 */
@Component({
  selector: "app-crm-campaign-list",
  templateUrl: "./list.component.html",
  standalone: false,
})
export class CrmCampaignListComponent
  extends ListBaseComponent<CrmCampaignService, CrmCampaignModel, string>
  implements OnInit, OnDestroy
{
  ...
  expandedElement: CrmCampaignModel | null;
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new CrmCampaignModel());
  ...
  onActionButtonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(CrmCampaignAddComponent, {
      height: "90%",
  ...
  onActionButtonEditRow(
    model: CrmCampaignModel = this.tableRowSelected,
  ): void {
    ...
    const dialogRef = this.dialog.open(CrmCampaignEditComponent, {
      height: "90%",
      panelClass: panelClass,
      enterAnimationDuration: environment.cmsViewConfig.enterAnimationDuration,
      exitAnimationDuration: environment.cmsViewConfig.exitAnimationDuration,
  ...
  isExpansionDetailRow = (index: number, row: CrmCampaignModel) =>
