...
/**
 * Component ویرایش Campaign در CRM.
 * این component فرم ویرایش Campaign موجود را نمایش می‌دهد.
 */
@Component({
  selector: "app-crm-campaign-edit",
  templateUrl: "./edit.component.html",
  standalone: false,
})
export class CrmCampaignEditComponent
  extends EditBaseComponent<CrmCampaignService, CrmCampaignModel, string>
  implements OnInit
{
