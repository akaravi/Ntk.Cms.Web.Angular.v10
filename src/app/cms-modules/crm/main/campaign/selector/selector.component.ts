...
/**
 * Component Selector برای انتخاب Campaign در فرم‌های CRM.
 * این component امکان جستجو و انتخاب Campaign را فراهم می‌کند.
 */
@Component({
  selector: "app-crm-campaign-selector",
  templateUrl: "./selector.component.html",
  standalone: false,
})
export class CrmCampaignSelectorComponent implements OnInit {
  ...
  constructor(
    ...
    public categoryService: CrmCampaignService,
  ) {
    this.publicHelper.processService.cdr = this.cdr;
  }
  dataModelResult: ErrorExceptionResult<CrmCampaignModel> =
    new ErrorExceptionResult<CrmCampaignModel>();
  dataModelSelect: CrmCampaignModel = new CrmCampaignModel();
  formControl = new FormControl();
  forceSelect: any;
  filteredOptions: Observable<CrmCampaignModel[]>;
  @Input() optionDisabled = false;
  @Input() optionSelectFirstItem = false;
  @Input() optionPlaceholder = "";
  @Input() optionLabel = "";
  @Input() optionRequired = false;
  @Output() optionChange = new EventEmitter<CrmCampaignModel>();
  @Input() optionReload = () => this.onActionButtonReload();
  @Input() set optionSelectForce(x: string | CrmCampaignModel) {
    this.forceSelect = x;
  ...
  displayFn(model?: CrmCampaignModel): string | undefined {
    return model ? model.name : undefined;
  }
  displayOption(model?: CrmCampaignModel): string | undefined {
    return model ? model.name : undefined;
  }
  async DataGetAll(
    text: string | number | any,
  ): Promise<Observable<CrmCampaignModel[]>> {
    const filterModel = new CrmCampaignFilterModel();
  ...
  onActionSelectForce(model: string | CrmCampaignModel): void {
  ...
  onActionSelect(model: CrmCampaignModel): void {
  ...
  onActionButtonReload(): void {
    this.dataModelSelect = new CrmCampaignModel();
    this.formControl.setValue(null);
