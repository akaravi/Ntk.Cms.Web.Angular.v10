...
/**
 * Component Selector برای انتخاب Pipeline در فرم‌های CRM.
 * این component امکان جستجو و انتخاب Pipeline را فراهم می‌کند.
 */
@Component({
  selector: "app-crm-pipeline-selector",
  templateUrl: "./selector.component.html",
  standalone: false,
})
export class CrmPipelineSelectorComponent implements OnInit {
  ...
  constructor(
    ...
    public categoryService: CrmPipelineService,
  ) {
    this.publicHelper.processService.cdr = this.cdr;
  }
  dataModelResult: ErrorExceptionResult<CrmPipelineModel> =
    new ErrorExceptionResult<CrmPipelineModel>();
  dataModelSelect: CrmPipelineModel = new CrmPipelineModel();
  formControl = new FormControl();
  forceSelect: any;
  filteredOptions: Observable<CrmPipelineModel[]>;
  @Input() optionDisabled = false;
  @Input() optionSelectFirstItem = false;
  @Input() optionPlaceholder = "";
  @Input() optionLabel = "";
  @Input() optionRequired = false;
  @Output() optionChange = new EventEmitter<CrmPipelineModel>();
  @Input() optionReload = () => this.onActionButtonReload();
  @Input() set optionSelectForce(x: string | CrmPipelineModel) {
    this.forceSelect = x;
  ...
  displayFn(model?: CrmPipelineModel): string | undefined {
    return model ? model.name : undefined;
  }
  displayOption(model?: CrmPipelineModel): string | undefined {
    return model ? model.name : undefined;
  }
  async DataGetAll(
    text: string | number | any,
  ): Promise<Observable<CrmPipelineModel[]>> {
    const filterModel = new CrmPipelineFilterModel();
  ...
  onActionSelectForce(model: string | CrmPipelineModel): void {
  ...
  onActionSelect(model: CrmPipelineModel): void {
  ...
  onActionButtonReload(): void {
    this.dataModelSelect = new CrmPipelineModel();
    this.formControl.setValue(null);
