...
import { CrmPipelineAddComponent } from "../add/add.component";
import { CrmPipelineEditComponent } from "../edit/edit.component";

/**
 * Component لیست Pipelineهای CRM.
 * این component لیست تمام Pipelineهای موجود را نمایش می‌دهد و امکان افزودن، ویرایش و حذف را فراهم می‌کند.
 */
@Component({
  selector: "app-crm-pipeline-list",
  templateUrl: "./list.component.html",
  standalone: false,
})
export class CrmPipelineListComponent
  extends ListBaseComponent<CrmPipelineService, CrmPipelineModel, string>
  implements OnInit, OnDestroy
{
  ...
  expandedElement: CrmPipelineModel | null;
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new CrmPipelineModel());
  ...
  onActionButtonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(CrmPipelineAddComponent, {
      height: "90%",
  ...
  onActionButtonEditRow(
    model: CrmPipelineModel = this.tableRowSelected,
  ): void {
    ...
    const dialogRef = this.dialog.open(CrmPipelineEditComponent, {
      height: "90%",
      panelClass: panelClass,
      enterAnimationDuration: environment.cmsViewConfig.enterAnimationDuration,
      exitAnimationDuration: environment.cmsViewConfig.exitAnimationDuration,
  ...
  isExpansionDetailRow = (index: number, row: CrmPipelineModel) =>
