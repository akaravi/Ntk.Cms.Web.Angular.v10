...
/**
 * Component Selector برای انتخاب Opportunity در فرم‌های CRM.
 * این component امکان جستجو و انتخاب Opportunity را فراهم می‌کند.
 */
@Component({
  selector: "app-crm-opportunity-selector",
  templateUrl: "./selector.component.html",
  standalone: false,
})
export class CrmOpportunitySelectorComponent implements OnInit {
  ...
  constructor(
    ...
    public categoryService: CrmOpportunityService,
  ) {
    this.publicHelper.processService.cdr = this.cdr;
  }
  dataModelResult: ErrorExceptionResult<CrmOpportunityModel> =
    new ErrorExceptionResult<CrmOpportunityModel>();
  dataModelSelect: CrmOpportunityModel = new CrmOpportunityModel();
  formControl = new FormControl();
  forceSelect: any;
  filteredOptions: Observable<CrmOpportunityModel[]>;
  @Input() optionDisabled = false;
  @Input() optionSelectFirstItem = false;
  @Input() optionPlaceholder = "";
  @Input() optionLabel = "";
  @Input() optionRequired = false;
  @Output() optionChange = new EventEmitter<CrmOpportunityModel>();
  @Input() optionReload = () => this.onActionButtonReload();
  @Input() set optionSelectForce(x: string | CrmOpportunityModel) {
    this.forceSelect = x;
  ...
  displayFn(model?: CrmOpportunityModel): string | undefined {
    if (model) {
      return (
        model.name +
  ...
  displayOption(model?: CrmOpportunityModel): string | undefined {
  ...
  onActionSelectForce(model: string | CrmOpportunityModel): void {
  ...
  onActionSelect(model: CrmOpportunityModel): void {
  ...
  onActionButtonReload(): void {
    this.dataModelSelect = new CrmOpportunityModel();
    this.formControl.setValue(null);
