...
import { CrmLeadAddComponent } from "../add/add.component";
import { CrmLeadEditComponent } from "../edit/edit.component";

/**
 * Component لیست Leadهای CRM.
 * این component لیست تمام Leadهای موجود را نمایش می‌دهد و امکان افزودن، ویرایش و حذف را فراهم می‌کند.
 */
@Component({
...
export class CrmLeadListComponent
  extends ListBaseComponent<CrmLeadService, CrmLeadModel, string>
  implements OnInit, OnDestroy
{
  ...
  constructor(
    private contentService: CrmLeadService,
  ...
  expandedElement: CrmLeadModel | null;
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new CrmLeadModel());
  ...
  onActionButtonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(CrmLeadAddComponent, {
      height: "90%",
  ...
  onActionButtonEditRow(
    model: CrmLeadModel = this.tableRowSelected,
  ): void {
    ...
    const dialogRef = this.dialog.open(CrmLeadEditComponent, {
      height: "90%",
      panelClass: panelClass,
      enterAnimationDuration: environment.cmsViewConfig.enterAnimationDuration,
      exitAnimationDuration: environment.cmsViewConfig.exitAnimationDuration,
    ...
    this.translate
      ...
      .subscribe((str: string) => {
        ...
        message =
          ...
          "?" +
          "<br> ( " +
          (this.tableRowSelected.title || this.tableRowSelected.firstName + " " + this.tableRowSelected.lastName) +
          " ) ";
      });
  ...
  isExpansionDetailRow = (index: number, row: CrmLeadModel) =>
