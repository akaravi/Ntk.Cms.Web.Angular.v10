...
/**
 * Component Selector برای انتخاب Account در فرم‌های CRM.
 * این component امکان جستجو و انتخاب Account را فراهم می‌کند.
 */
@Component({
  selector: "app-crm-account-selector",
  templateUrl: "./selector.component.html",
  standalone: false,
})
export class CrmAccountSelectorComponent implements OnInit {
  ...
  constructor(
    ...
    public categoryService: CrmAccountService,
  ) {
    this.publicHelper.processService.cdr = this.cdr;
  }
  dataModelResult: ErrorExceptionResult<CrmAccountModel> =
    new ErrorExceptionResult<CrmAccountModel>();
  dataModelSelect: CrmAccountModel = new CrmAccountModel();
  formControl = new FormControl();
  forceSelect: any;
  filteredOptions: Observable<CrmAccountModel[]>;
  @Input() optionDisabled = false;
  @Input() optionSelectFirstItem = false;
  @Input() optionPlaceholder = "";
  @Input() optionLabel = "";
  @Input() optionRequired = false;
  @Output() optionChange = new EventEmitter<CrmAccountModel>();
  @Input() optionReload = () => this.onActionButtonReload();
  @Input() set optionSelectForce(x: string | CrmAccountModel) {
    this.forceSelect = x;
  ...
  onActionSelectForce(model: string | CrmAccountModel): void {
  ...
  onActionSelect(model: CrmAccountModel): void {
  ...
  onActionButtonReload(): void {
    this.dataModelSelect = new CrmAccountModel();
    this.formControl.setValue(null);
