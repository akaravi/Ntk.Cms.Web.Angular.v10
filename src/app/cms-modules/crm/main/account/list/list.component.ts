...
import { CrmAccountAddComponent } from "../add/add.component";
import { CrmAccountEditComponent } from "../edit/edit.component";

/**
 * Component لیست Accountهای CRM.
 * این component لیست تمام Accountهای موجود را نمایش می‌دهد و امکان افزودن، ویرایش و حذف را فراهم می‌کند.
 */
@Component({
  selector: "app-crm-account-list",
  templateUrl: "./list.component.html",
  standalone: false,
})
export class CrmAccountListComponent
  extends ListBaseComponent<CrmAccountService, CrmAccountModel, string>
  implements OnInit, OnDestroy
{
  requestLinkParentAccountId = "";
  ...
  constructor(
    ...
    this.requestLinkParentAccountId =
      this.activatedRoute.snapshot.paramMap.get("LinkParentAccountId");
    this.requestLinkCampaignId =
      this.activatedRoute.snapshot.paramMap.get("LinkCampaignId");
  ...
  @Input() set optionLinkParentAccountId(id: string) {
    this.requestLinkParentAccountId = "";
    if (id && id.length > 0) {
  ...
  expandedElement: CrmAccountModel | null;
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new CrmAccountModel());
    ...
    if (
      ...
      filter.propertyName = "linkParentAccountId";
      filter.value = this.requestLinkParentAccountId;
  ...
  onActionButtonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(CrmAccountAddComponent, {
      height: "90%",
  ...
  onActionButtonEditRow(
    model: CrmAccountModel = this.tableRowSelected,
  ): void {
    ...
    const dialogRef = this.dialog.open(CrmAccountEditComponent, {
      height: "90%",
      panelClass: panelClass,
      enterAnimationDuration: environment.cmsViewConfig.enterAnimationDuration,
      exitAnimationDuration: environment.cmsViewConfig.exitAnimationDuration,
  ...
  isExpansionDetailRow = (index: number, row: CrmAccountModel) =>
