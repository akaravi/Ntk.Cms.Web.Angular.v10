...
/**
 * Component ویرایش Stage در CRM.
 * این component فرم ویرایش Stage موجود را نمایش می‌دهد.
 */
@Component({
  selector: "app-crm-stage-edit",
  templateUrl: "./edit.component.html",
  standalone: false,
})
export class CrmStageEditComponent
  extends EditBaseComponent<CrmStageService, CrmStageModel, string>
  implements OnInit
{
