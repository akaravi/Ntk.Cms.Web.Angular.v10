...
import {
  ...
  CrmStageService,
  TokenInfoModelV3,
  CrmPipelineModel } from "ntk-cms-api";
...
/**
 * Component افزودن Stage جدید در CRM.
 * این component فرم افزودن Stage جدید را نمایش می‌دهد.
 */
@Component({
  selector: "app-crm-stage-add",
  templateUrl: "./add.component.html",
  standalone: false,
})
export class CrmStageAddComponent
  extends AddBaseComponent<CrmStageService, CrmStageModel, string>
  implements OnInit
{
  ...
  constructor(
    ...
    super(crmStageService, new CrmStageModel(), publicHelper, translate);
  ...
  DataAddContent(): void {
    ...
    this.crmStageService.ServiceAdd(this.dataModel).subscribe({
      next: (ret) => {
