...
import { CrmStageAddComponent } from "../add/add.component";
import { CrmStageEditComponent } from "../edit/edit.component";

/**
 * Component لیست Stageهای CRM.
 * این component لیست تمام Stageهای موجود را نمایش می‌دهد و امکان افزودن، ویرایش و حذف را فراهم می‌کند.
 */
@Component({
  selector: "app-crm-stage-list",
  templateUrl: "./list.component.html",
  standalone: false,
})
export class CrmStageListComponent
  extends ListBaseComponent<CrmStageService, CrmStageModel, string>
  implements OnInit, OnDestroy
{
  ...
  expandedElement: CrmStageModel | null;
  ...
  onActionButtonNewRow(): void {
    ...
    const dialogRef = this.dialog.open(CrmStageAddComponent, {
      height: "90%",
  ...
  onActionButtonEditRow(
    ...
    const dialogRef = this.dialog.open(CrmStageEditComponent, {
      height: "90%",
      panelClass: panelClass,
      enterAnimationDuration: environment.cmsViewConfig.enterAnimationDuration,
      exitAnimationDuration: environment.cmsViewConfig.exitAnimationDuration,
  ...
  isExpansionDetailRow = (index: number, row: CrmStageModel) =>
