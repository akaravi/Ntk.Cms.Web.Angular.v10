...
import { CoreModuleDataTaskListComponent } from "./list.component";

@Component({
  selector: "app-coremodule-data-task-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class CoreModuleDataTaskListMobileComponent extends CoreModuleDataTaskListComponent {
