...
import {
  CoreEnumService, CoreModuleDataTaskModel, CoreModuleDataTaskService, CoreSiteModel,
...
export class CoreModuleDataTaskListComponent extends ListBaseComponent<CoreModuleDataTaskService, CoreModuleDataTaskModel, string>
  ...
  constructor(
    ...
    super(contentService, new CoreModuleDataTaskModel(), publicHelper, tokenHelper, translate);
