...
import { CoreModuleDataMemoListComponent } from "./list.component";

@Component({
  selector: "app-coremodule-data-memo-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class CoreModuleDataMemoListMobileComponent extends CoreModuleDataMemoListComponent {
