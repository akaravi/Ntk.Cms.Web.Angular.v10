...
import {
  CoreEnumService, CoreModuleDataMemoModel, CoreModuleDataMemoService, CoreSiteModel,
...
export class CoreModuleDataMemoListComponent extends ListBaseComponent<CoreModuleDataMemoService, CoreModuleDataMemoModel, string>
  ...
  constructor(
    ...
    super(contentService, new CoreModuleDataMemoModel(), publicHelper, tokenHelper, translate);
