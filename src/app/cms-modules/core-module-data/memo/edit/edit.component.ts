...
import {
  CoreEnumService, CoreModuleDataMemoModel, CoreModuleDataMemoService,
...
export class CoreModuleDataMemoEditComponent extends EditBaseComponent<CoreModuleDataMemoService, CoreModuleDataMemoModel, string>
