...
import {
  CoreEnumService, CoreModuleDataCommentModel, CoreModuleDataCommentService, CoreSiteModel,
...
export class CoreModuleDataCommentListComponent extends ListBaseComponent<CoreModuleDataCommentService, CoreModuleDataCommentModel, string>
  ...
  constructor(
    ...
    super(contentService, new CoreModuleDataCommentModel(), publicHelper, tokenHelper, translate);
