...
import { CoreModuleDataCommentListComponent } from "./list.component";

@Component({
  selector: "app-coremodule-data-comment-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class CoreModuleDataCommentListMobileComponent extends CoreModuleDataCommentListComponent {
