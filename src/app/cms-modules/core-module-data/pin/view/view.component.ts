...
@Component({
  selector: "app-coremodule-data-pin-view",
  templateUrl: "./view.component.html",
  standalone: false,
})
export class CoreModuleDataPinViewComponent implements OnInit, OnDestroy {
  requestId = "";
  constructorInfoAreaId = this.constructor.name;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<CoreModuleDataPinViewComponent>,
  ...
  dataModelResult: ErrorExceptionResult<CoreModuleDataPinModel> =
    new ErrorExceptionResult<CoreModuleDataPinModel>();
