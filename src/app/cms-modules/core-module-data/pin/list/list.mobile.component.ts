...
import { CoreModuleDataPinListComponent } from "./list.component";

@Component({
  selector: "app-coremodule-data-pin-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class CoreModuleDataPinListMobileComponent extends CoreModuleDataPinListComponent {
