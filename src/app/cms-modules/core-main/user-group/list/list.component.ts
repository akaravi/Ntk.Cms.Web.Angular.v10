...
export class CoreUserGroupListComponent
  extends ListBaseComponent<CoreUserGroupService, CoreUserGroupModel, number>
  implements OnInit, OnDestroy
{
  ...
  onActionButtonEditRow(
    model: CoreUserGroupModel = this.tableRowSelected,
  ): void {
  ...
  onActionButtonUserList(
    ...
    this.router.navigate([
      "/core/site/userlist/LinkUserGroupId/",
