...
export class CoreUserGroupEditComponent
  extends EditBaseComponent<CoreUserGroupService, CoreUserGroupModel, number>
  implements OnInit
{
  requestId = 0;
  ...
  DataGetOneContent(): void {
    ...
    this.coreUserGroupService.setAccessDataType(
