  ...
  implements OnInit
{
  ...
  ngOnInit(): void {
    if (
      this.requestLinkCmsSiteCategoryId <= 0 ||
      this.requestLinkCmsModuleId <= 0
    ) {
  ...
  DataGetOneContent(): void {
    ...
    this.coreSiteCategoryCmsModuleService.setAccessDataType(
          ...
          if (ret.isSuccess) {
            if (ret.listItems && ret.listItems.length > 0) {
              ...
              this.formInfo.formTitle =
                this.formInfo.formTitle +
                " " +
                ret.item.linkCmsModuleId +
                "<==>" +
                ret.item.linkCmsSiteCategoryId;
              this.formInfo.submitResultMessage = "";
