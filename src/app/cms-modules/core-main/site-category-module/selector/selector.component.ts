...
export class CoreSiteCategoryCmsModuleSelectorComponent implements OnInit {
  static nextId = 0;
  id = ++CoreSiteCategoryCmsModuleSelectorComponent.nextId;
  ...
  dataModelSelect: CoreSiteCategoryCmsModuleModel =
  ...
  ): Promise<CoreSiteCategoryCmsModuleModel[]> {
  ...
  push(
    newvalue: CoreSiteCategoryCmsModuleModel,
  ): Observable<CoreSiteCategoryCmsModuleModel[]> {
