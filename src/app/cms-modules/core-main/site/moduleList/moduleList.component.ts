...
export class CoreSiteModuleListComponent
  extends ListBaseComponent<CoreModuleSiteService, CoreModuleSiteModel, number>
  implements OnInit, OnDestroy
{
  ...
  onActionButtonEditRow(
    model: CoreModuleSiteModel = this.tableRowSelected,
  ): void {
  ...
  onActionButtonConfigSiteRow(
    ...
    if (event?.ctrlKey) {
      window.open(
        model.virtual_CmsModule.className.toLowerCase() +
          "/config/site/" +
          model.linkSiteId,
        "_blank",
      );
      ...
      this.router.navigate([
        model.virtual_CmsModule.className.toLowerCase() + "/config/site/",
        model.linkSiteId,
      ]);
    }
  }
  onActionButtonConfigMainAdminRow(
    ...
    if (event?.ctrlKey) {
      window.open(
        model.virtual_CmsModule.className.toLowerCase() + "/config/mainadmin/",
        "_blank",
      );
    } else {
      this.router.navigate([
  ...
  onActionButtonSiteCreditAccountRow(
    model: CoreModuleSiteModel = this.tableRowSelected,
  ): void {
    if (
      !model ||
  ...
  onActionButtonSiteUserCreditAccountRow(
    model: CoreModuleSiteModel = this.tableRowSelected,
  ): void {
    if (
      !model ||
