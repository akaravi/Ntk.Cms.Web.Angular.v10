...
export class CoreCurrencyEditComponent
  extends EditBaseComponent<CoreCurrencyService, CoreCurrencyModel, number>
  implements OnInit
{
  requestId = 0;
  ...
  DataGetOneContent(): void {
    ...
    this.coreCurrencyService.setAccessDataType(
