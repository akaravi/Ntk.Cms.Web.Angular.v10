...
export class CoreCurrencyAddComponent
  extends AddBaseComponent<CoreCurrencyService, CoreCurrencyModel, number>
  implements OnInit
{
  ...
  dataModelResult: ErrorExceptionResult<CoreCurrencyModel> =
