...
export class CoreCurrencyListComponent
  extends ListBaseComponent<CoreCurrencyService, CoreCurrencyModel, number>
  implements OnInit, OnDestroy
{
  ...
  onActionButtonEditRow(
    model: CoreCurrencyModel = this.tableRowSelected,
  ): void {
  ...
  onActionButtonUserList(
    ...
    this.router.navigate([
      "/core/site/userlist/LinkCurrencyId/",
