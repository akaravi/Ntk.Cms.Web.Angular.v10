...
export class CoreModuleSaleHeaderListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    this.requestHeaderGroupId = +Number(
      this.activatedRoute.snapshot.paramMap.get("LinkHeaderGroupId"),
    );
  ...
  categoryModelSelected: CoreModuleSaleHeaderGroupModel =
  ...
  onActionButtonItemList(
    ...
    this.router.navigate([
      "/core/modulesale/item/LinkModuleSaleHeader/",
      this.tableRowSelected.id,
    ]);
  }
  ...
  onActionButtonModuleList(
    ...
    this.router.navigate([
      "/core/sitecategorymodule/LinkCmsModuleSaleHeaderId",
      this.tableRowSelected.id,
    ]);
  }
  onActionButtonSiteList(
    ...
    this.router.navigate([
      "/core/site/list/LinkModuleSaleHeaderId",
      this.tableRowSelected.id,
    ]);
  }
