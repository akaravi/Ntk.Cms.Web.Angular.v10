...
import {
  CoreEnumService, CoreModuleSaleHeaderGroupModel, CoreModuleSaleHeaderModel, CoreModuleSaleHeaderService,
...
export class CoreModuleSaleHeaderEditComponent extends EditBaseComponent<CoreModuleSaleHeaderService, CoreModuleSaleHeaderModel, number>
  implements OnInit {
  requestId = 0;
  ...
  constructor(
    ...
    super(coreModuleSaleHeaderService, new CoreModuleSaleHeaderModel(), publicHelper, translate);
