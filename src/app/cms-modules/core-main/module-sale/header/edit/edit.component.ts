...
export class CoreModuleSaleHeaderEditComponent
  ...
  implements OnInit
{
  ...
  DataGetOneContent(): void {
    ...
    this.coreModuleSaleHeaderService.setAccessDataType(
  ...
  onActionSelectHeaderGroup(
    model: CoreModuleSaleHeaderGroupModel | null,
  ): void {
    if (!model || model.id <= 0) {
      this.translate
        .get([
