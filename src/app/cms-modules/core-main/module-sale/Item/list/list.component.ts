...
export class CoreModuleSaleItemListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    this.requestLinkModuleSaleHeader = +Number(
      this.activatedRoute.snapshot.paramMap.get("LinkModuleSaleHeader"),
    );
