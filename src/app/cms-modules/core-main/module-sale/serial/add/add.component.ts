...
export class CoreModuleSaleSerialAddComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    if (this.requestLinkModuleSaleHeaderId > 0) {
      this.dataModel.linkModuleSaleHeaderId =
        this.requestLinkModuleSaleHeaderId;
    }
  ...
  dataModelResult: ErrorExceptionResult<CoreModuleSaleSerialModel> =
    new ErrorExceptionResult<CoreModuleSaleSerialModel>();
