...
export class CoreModuleSaleInvoiceListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    super(
      contentService,
      new CoreModuleSaleInvoiceModel(),
      publicHelper,
      tokenHelper,
      translate,
    );
  ...
  categoryModelSelected: CoreModuleSaleSerialModel =
  ...
  onActionButtonViewDetail(
    ...
    this.router.navigate([
      "/core/modulesale/invoicedetail/LinkInvoiceId",
      this.tableRowSelected.id,
    ]);
  }
  ...
  onActionButtonModuleList(
    ...
    this.router.navigate([
      "/core/sitecategorymodule/LinkCmsModuleSaleInvoiceId",
      this.tableRowSelected.id,
    ]);
  }
  onActionButtonSiteList(
    ...
    this.router.navigate([
      "/core/site/list/LinkModuleSaleInvoiceId",
      this.tableRowSelected.id,
    ]);
  }
