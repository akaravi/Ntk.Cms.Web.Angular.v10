...
export class CoreUserClaimGroupSelectorComponent implements OnInit {
  ...
  dataModelResult: ErrorExceptionResult<CoreUserClaimGroupModel> =
  ...
  ): Promise<CoreUserClaimGroupModel[]> {
  ...
  push(
    newvalue: CoreUserClaimGroupModel,
  ): Observable<CoreUserClaimGroupModel[]> {
