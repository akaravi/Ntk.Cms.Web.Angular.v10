...
export class CoreUserClaimTypeListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  dataModelEnumUserClaimKindsResult: ErrorExceptionResult<InfoEnumModel> =
  ...
  onActionButtonEditRow(
    model: CoreUserClaimTypeModel = this.tableRowSelected,
  ): void {
  ...
  onActionButtonDetailList(
    ...
    this.router.navigate([
      "/core/userclaim/groupdetail/LinkUserClaimTypeId",
  ...
  onActionButtonModuleList(
    ...
    this.router.navigate([
      "/core/sitecategorymodule/LinkCmsUserClaimTypeId",
      this.tableRowSelected.id,
    ]);
  }
  onActionButtonSiteList(
    ...
    this.router.navigate([
      "/core/site/list/LinkUserClaimTypeId",
      this.tableRowSelected.id,
    ]);
  }
