...
export class CoreUserClaimGroupDetailEditComponent
  ...
  implements OnInit
{
  ...
  DataGetOneContent(): void {
    ...
    this.coreUserClaimGroupDetailService.setAccessDataType(
        ...
        next: (ret) => {
          ...
          if (ret.isSuccess && ret.listItems.length > 0) {
            ...
            this.formInfo.formTitle =
              this.formInfo.formTitle +
              " " +
              this.dataModel.linkUserClaimGroupId +
              "<-->" +
              this.dataModel.linkUserClaimTypeId;
            this.formInfo.submitResultMessage = "";
          } else {
            this.translate
