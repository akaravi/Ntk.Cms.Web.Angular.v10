...
export class CoreUserClaimGroupDetailSelectorComponent implements OnInit {
  static nextId = 0;
  id = ++CoreUserClaimGroupDetailSelectorComponent.nextId;
  ...
  ): Promise<CoreUserClaimGroupDetailModel[]> {
  ...
  push(
    newvalue: CoreUserClaimGroupDetailModel,
  ): Observable<CoreUserClaimGroupDetailModel[]> {
