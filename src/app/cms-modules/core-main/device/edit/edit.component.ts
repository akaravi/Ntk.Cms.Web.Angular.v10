...
import {
  CoreDeviceModel, CoreDeviceService, CoreEnumService, CoreSiteModel,
...
export class CoreDeviceEditComponent extends EditBaseComponent<CoreDeviceService, CoreDeviceModel, number>
  implements OnInit {
  requestId = 0;
