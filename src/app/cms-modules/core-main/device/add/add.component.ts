...
export class CoreDeviceAddComponent
  extends AddBaseComponent<CoreDeviceService, CoreDeviceModel, number>
  implements OnInit
{
  ...
  dataModelResult: ErrorExceptionResult<CoreDeviceModel> =
    new ErrorExceptionResult<CoreDeviceModel>();
