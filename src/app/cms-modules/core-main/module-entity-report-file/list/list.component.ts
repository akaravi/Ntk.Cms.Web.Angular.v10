...
export class CoreModuleEntityReportFileListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    this.requestLinkModuleEntityId = +Number(
      this.activatedRoute.snapshot.paramMap.get("LinkModuleEntityReportFileId"),
    );
  ...
  dataModelCoreModuleEntityResult: ErrorExceptionResult<CoreModuleEntityModel> =
    new ErrorExceptionResult<CoreModuleEntityModel>();
  dataModelEnumReportFileTypeResult: ErrorExceptionResult<InfoEnumModel> =
  ...
  onActionButtonModuleEntityDataReportRow(
    ...
    this.router.navigate([
      "corelog/report-data/LinkModuleEntityReportFileId/",
      model.id,
    ]);
  }
