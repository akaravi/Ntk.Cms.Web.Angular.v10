...
export class CoreLocationEditComponent
  extends EditBaseComponent<CoreLocationService, CoreLocationModel, number>
  implements OnInit
{
  requestId = 0;
  ...
  DataGetOneContent(): void {
    ...
    this.coreLocationService.setAccessDataType(
