...
export class CoreModuleEditComponent
  extends EditBaseComponent<CoreModuleService, CoreModuleModel, number>
  implements OnInit
{
  requestId = 0;
  ...
  constructor(
    ...
    super(coreModuleService, new CoreModuleModel(), publicHelper, translate);
  ...
  DataGetOneContent(): void {
    ...
    this.coreModuleService.setAccessDataType(
