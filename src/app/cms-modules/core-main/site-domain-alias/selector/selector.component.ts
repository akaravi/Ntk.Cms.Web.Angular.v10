...
export class CoreSiteDomainAliasSelectorComponent implements OnInit {
  static nextId = 0;
  id = ++CoreSiteDomainAliasSelectorComponent.nextId;
  ...
  dataModelResult: ErrorExceptionResult<CoreSiteDomainAliasModel> =
    new ErrorExceptionResult<CoreSiteDomainAliasModel>();
  ...
  ): Promise<CoreSiteDomainAliasModel[]> {
  ...
  push(
    newvalue: CoreSiteDomainAliasModel,
  ): Observable<CoreSiteDomainAliasModel[]> {
