...
export class CoreModuleSiteUserCreditListComponent extends ListBaseComponent<CoreModuleSiteUserCreditService, CoreModuleSiteUserCreditModel, number>
  ...
  constructor(
    ...
    super(contentService, new CoreModuleSiteUserCreditModel(), publicHelper, tokenHelper, translate);
...
if (this.tokenInfo) {
  ...
  onActionButtonDeleteRow(model: CoreModuleSiteUserCreditModel = this.tableRowSelected): void {
    ...
    this.translate.get(['MESSAGE.Please_Confirm', 'MESSAGE.Do_you_want_to_delete_this_content']).subscribe((str: string) => {
      ...
      message = str['MESSAGE.Do_you_want_to_delete_this_content'] + '?' + '<br> ( ' + this.tableRowSelected.linkUserId + ' ) ';
    });
