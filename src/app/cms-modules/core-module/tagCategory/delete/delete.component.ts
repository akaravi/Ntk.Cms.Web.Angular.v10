...
import {CoreModuleTagCategoryModel,
...
export class CoreModuleTagCategoryDeleteComponent implements OnInit {
  ...
  dataModelResultCategoryAllData: ErrorExceptionResult<CoreModuleTagCategoryModel> =
    new ErrorExceptionResult<CoreModuleTagCategoryModel>();
  dataModel: any = {};
  ...
  DataGetOne(): void {
    ...
    this.coreModuleTagCategoryService.setAccessDataType(
  ...
  DataGetAll(): void {
    ...
    this.coreModuleTagCategoryService.ServiceGetAll(filterModel).subscribe({
      next: (ret) => {
