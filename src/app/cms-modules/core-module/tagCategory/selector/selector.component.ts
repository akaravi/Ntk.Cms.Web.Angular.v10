...
export class CoreModuleTagCategorySelectorComponent implements OnInit {
  static nextId = 0;
  id = ++CoreModuleTagCategorySelectorComponent.nextId;
  ...
  ): Promise<CoreModuleTagCategoryModel[]> {
  ...
  push(
    newvalue: CoreModuleTagCategoryModel,
  ): Observable<CoreModuleTagCategoryModel[]> {
