...
export class DataProviderPlanSourceAddComponent extends AddBaseComponent<DataProviderPlanSourceService, DataProviderPlanSourceModel, number> implements OnInit {
  requestPlanId = 0;
