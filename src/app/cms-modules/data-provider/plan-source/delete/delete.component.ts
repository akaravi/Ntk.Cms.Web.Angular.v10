...
export class DataProviderPlanSourceDeleteComponent implements OnInit {
  requestId = 0;
  constructorInfoAreaId = this.constructor.name;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<DataProviderPlanSourceDeleteComponent>,
  ...
  dataModelResultContent: ErrorExceptionResult<DataProviderPlanSourceModel> =
  ...
  DataGetOne(): void {
    ...
    this.dataProviderPlanSourceService.setAccessDataType(
  ...
  onFormDelete(): void {
    ...
    this.dataProviderPlanSourceService.ServiceDelete(this.requestId).subscribe({
      next: (ret) => {
