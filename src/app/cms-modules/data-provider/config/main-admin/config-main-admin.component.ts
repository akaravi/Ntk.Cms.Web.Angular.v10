...
import {AccessModel,
  ...
  DataProviderModuleConfigSiteValuesModel,TokenInfoModelV3} from "ntk-cms-api";
...
export class DataProviderConfigMainAdminComponent implements OnInit, OnDestroy {
  ...
  dataConfigSiteValuesDefaultModel =
    new DataProviderModuleConfigSiteValuesModel();
  dataConfigSiteAccessValuesDefaultModel =
    new DataProviderModuleConfigSiteAccessValuesModel();
