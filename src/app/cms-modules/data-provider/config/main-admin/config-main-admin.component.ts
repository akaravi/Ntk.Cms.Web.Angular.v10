...
import {
  ...
  DataProviderModuleConfigSiteValuesModel, FormInfoModel, TokenInfoModelV3
} from 'ntk-cms-api';
...
export class DataProviderConfigMainAdminComponent implements OnInit, OnDestroy {
  requestLinkSiteId = 0;
  ...
  dataConfigSiteValuesDefaultModel = new DataProviderModuleConfigSiteValuesModel();
  dataConfigSiteAccessValuesDefaultModel = new DataProviderModuleConfigSiteAccessValuesModel();
  dataConfigAdminMainModel = new DataProviderModuleConfigAdminMainValuesModel();
