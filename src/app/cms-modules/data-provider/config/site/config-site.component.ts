...
export class DataProviderConfigSiteComponent implements OnInit,OnDestroy {
  requestLinkSiteId = 0;
  ...
  dataSiteStorageModel = new DataProviderModuleSiteStorageValuesModel();
  dataConfigSiteValuesModel = new DataProviderModuleConfigSiteValuesModel();
  dataConfigSiteAccessValuesModel = new DataProviderModuleConfigSiteAccessValuesModel();
