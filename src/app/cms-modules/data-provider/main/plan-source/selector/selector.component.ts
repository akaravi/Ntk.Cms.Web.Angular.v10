...
export class DataProviderPlanSourceSelectorComponent implements OnInit {
  ...
  dataModelResult: ErrorExceptionResult<DataProviderPlanSourceModel> =
    new ErrorExceptionResult<DataProviderPlanSourceModel>();
  dataModelSelect: DataProviderPlanSourceModel =
    new DataProviderPlanSourceModel();
  ...
  @Input() set optionSelectForce(x: string | number | DataProviderPlanSourceModel) {
  ...
  ): Promise<DataProviderPlanSourceModel[]> {
  ...
  push(
    newvalue: DataProviderPlanSourceModel,
  ): Observable<DataProviderPlanSourceModel[]> {
  ...
  onActionSelectForce(id: string | number | DataProviderPlanSourceModel): void {
