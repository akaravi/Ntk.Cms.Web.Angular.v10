...
export class DataProviderPlanCategorySelectorComponent implements OnInit {
  ...
  @Input() set optionSelectForce(x: string | number | DataProviderPlanCategoryModel) {
  ...
  ): Promise<DataProviderPlanCategoryModel[]> {
  ...
  push(
    newvalue: DataProviderPlanCategoryModel,
  ): Observable<DataProviderPlanCategoryModel[]> {
  ...
  onActionSelectForce(id: string | number | DataProviderPlanCategoryModel): void {
