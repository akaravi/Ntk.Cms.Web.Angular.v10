...
export class DataProviderPlanCategoryDeleteComponent implements OnInit {
  ...
  dataModelResultCategory: ErrorExceptionResult<DataProviderPlanCategoryModel> =
    new ErrorExceptionResult<DataProviderPlanCategoryModel>();
  dataModelResultCategoryAllData: ErrorExceptionResult<DataProviderPlanCategoryModel> =
    new ErrorExceptionResult<DataProviderPlanCategoryModel>();
  dataModel: any = {};
  ...
  DataGetOne(): void {
    ...
    this.dataProviderPlanCategoryService.setAccessDataType(
  ...
  DataGetAll(): void {
    ...
    this.dataProviderPlanCategoryService.ServiceGetAll(filterModel).subscribe({
      next: (ret) => {
