...
export class DataProviderPlanClientSelectorComponent implements OnInit {
  ...
  @Input() set optionSelectForce(x: string | number | DataProviderPlanClientModel) {
  ...
  ): Promise<DataProviderPlanClientModel[]> {
  ...
  push(
    newvalue: DataProviderPlanClientModel,
  ): Observable<DataProviderPlanClientModel[]> {
  ...
  onActionSelectForce(id: string | number | DataProviderPlanClientModel): void {
