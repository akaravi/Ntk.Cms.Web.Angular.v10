...
export class DataProviderPlanClientDeleteComponent implements OnInit {
  requestId = 0;
  constructorInfoAreaId = this.constructor.name;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<DataProviderPlanClientDeleteComponent>,
  ...
  dataModelResultContent: ErrorExceptionResult<DataProviderPlanClientModel> =
  ...
  onFormDelete(): void {
    ...
    this.dataProviderPlanClientService.ServiceDelete(this.requestId).subscribe({
      next: (ret) => {
