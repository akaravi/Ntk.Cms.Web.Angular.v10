...
export class DataProviderPlanListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  onActionButtonNewRow(): void {
    if (
      ...
      !this.categoryModelSelected.id || this.categoryModelSelected.id.length === 0
    ) {
      this.translate
  ...
  onActionButtonPriceList(
    ...
    if (event?.ctrlKey) {
      ...
      this.router.navigate([
        "/data-provider/plan-price/LinkPlanId/" + model.id,
      ]);
    }
  }
  onActionButtonSourceList(
    ...
    if (event?.ctrlKey) {
      ...
      this.router.navigate([
        "/data-provider/plan-source/LinkPlanId/" + model.id,
      ]);
    }
  }
  onActionButtonClientList(
    ...
    if (event?.ctrlKey) {
      ...
      this.router.navigate([
        "/data-provider/plan-client/LinkPlanId/" + model.id,
      ]);
    }
  }
  ...
  onActionButtonTransactionList(
    ...
    if (event?.ctrlKey) {
      ...
      this.router.navigate([
        "/data-provider/transaction/LinkPlanId/" + model.id,
      ]);
    }
  }
