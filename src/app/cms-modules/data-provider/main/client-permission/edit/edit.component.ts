...
@Component({
  selector: "app-data-provider-client-permission-edit",
  templateUrl: "./edit.component.html",
  standalone: false,
})
export class DataProviderClientPermissionEditComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<DataProviderClientPermissionEditComponent>,
    public dataProviderClientPermissionService: DataProviderClientPermissionService,
    ...
    super(
      dataProviderClientPermissionService,
      new DataProviderClientPermissionModel(),
      publicHelper,
      translate,
    );
  ...
  dataModel: DataProviderClientPermissionModel = new DataProviderClientPermissionModel();
  ...
  DataGetOneContent(): void {
    ...
    this.dataProviderClientPermissionService.setAccessLoad();
    this.dataProviderClientPermissionService.setAccessDataType(
      ManageUserAccessDataTypesEnum.Editor,
    );
    this.dataProviderClientPermissionService
  ...
  DataEditContent(): void {
    ...
    this.dataProviderClientPermissionService.ServiceEdit(this.dataModel).subscribe({
      next: (ret) => {
