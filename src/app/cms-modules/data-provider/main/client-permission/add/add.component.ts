...
@Component({
  selector: "app-data-provider-client-permission-add",
  templateUrl: "./add.component.html",
  standalone: false,
})
export class DataProviderClientPermissionAddComponent
  ...
  implements OnInit
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<DataProviderClientPermissionAddComponent>,
  ...
  dataModelResult: ErrorExceptionResult<DataProviderClientPermissionModel> =
    new ErrorExceptionResult<DataProviderClientPermissionModel>();
  ...
  DataAddContent(): void {
    ...
    this.dataProviderClientPermissionService.ServiceAdd(this.dataModel).subscribe({
      next: (ret) => {
