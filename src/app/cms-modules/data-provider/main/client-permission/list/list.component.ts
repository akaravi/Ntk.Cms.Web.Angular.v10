...
@Component({
  selector: "app-data-provider-client-permission-list",
  templateUrl: "./list.component.html",
  standalone: false,
})
export class DataProviderClientPermissionListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    public contentService: DataProviderClientPermissionService,
  ...
  DataGetAll(): void {
    ...
    this.onActionTableRowSelect(new DataProviderClientPermissionModel());
  ...
  onActionTableRowSelect(row: DataProviderClientPermissionModel): void {
