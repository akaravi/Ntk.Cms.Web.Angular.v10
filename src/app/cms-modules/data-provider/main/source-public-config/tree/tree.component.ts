...
@Component({
  selector: "app-data-provider-source-public-config-tree",
  templateUrl: "./tree.component.html",

  standalone: false,
})
export class DataProviderSourcePublicConfigTreeComponent
  ...
  dataSource =
    new MatTreeNestedDataSource<DataProviderSourcePublicConfigModel>();
  @Output() optionChange =
    new EventEmitter<DataProviderSourcePublicConfigModel>();
  private unsubscribe: Subscription[] = [];
  @Input() optionReload = () => this.onActionButtonReload();

  hasChild = (_: string, node: DataProviderSourcePublicConfigModel) => false;
  childrenAccessor = (node: DataProviderSourcePublicConfigModel) => [];
