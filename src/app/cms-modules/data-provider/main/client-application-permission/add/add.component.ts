  ...
  implements OnInit
{
  ...
  constructor(
    ...
    if (data) {
      if (data.LinkClientApplicationId) {
        this.dataModel.linkClientApplicationId = data.LinkClientApplicationId;
      }
      if (data.LinkSourcePathId) {
        this.dataModel.linkSourcePathId = data.LinkSourcePathId;
      }
    }
  }
  ...
  dataModelResult: ErrorExceptionResult<DataProviderClientApplicationPermissionModel> =
