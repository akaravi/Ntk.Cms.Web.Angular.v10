...
export class DataProviderClientApplicationPermissionListComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  tableData: DataProviderClientApplicationPermissionModel[] = [];
  ...
  expandedElement: DataProviderClientApplicationPermissionModel | null;
    ...
    const dialogRef = this.dialog.open(
      DataProviderClientApplicationPermissionAddComponent,
      {
        ...
        data: {
          ...
          LinkSourcePathId: this.requestLinkSourcePathId,
        },
      },
    );
