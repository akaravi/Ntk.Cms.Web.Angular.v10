...
@Component({
  selector: "app-data-provider-source-company-tree",
  templateUrl: "./tree.component.html",

  standalone: false,
})
export class DataProviderSourceCompanyTreeComponent implements OnInit, OnDestroy {
  ...
  dataModelSelect: DataProviderSourceCompanyModel | null =
  ...
  dataSource = new MatTreeNestedDataSource<DataProviderSourceCompanyModel>();
  @Output() optionChange = new EventEmitter<DataProviderSourceCompanyModel>();
  private unsubscribe: Subscription[] = [];
  @Input() optionReload = () => this.onActionButtonReload();

  hasChild = (_: number, node: DataProviderSourceCompanyModel) => false;
  childrenAccessor = (node: DataProviderSourceCompanyModel) => [];
