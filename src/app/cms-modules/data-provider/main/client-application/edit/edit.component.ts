  ...
  implements OnInit, OnDestroy
{
  ...
  dataModel: DataProviderClientApplicationModel = new DataProviderClientApplicationModel();
  ...
  DataGetOneContent(): void {
    ...
    this.dataProviderClientApplicationService.ServiceGetOneById(this.requestId).subscribe({
      next: (ret) => {
  ...
  DataEditContent(): void {
    ...
    this.dataProviderClientApplicationService.ServiceEdit(this.dataModel).subscribe({
      next: (ret) => {
