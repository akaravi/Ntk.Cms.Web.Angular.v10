...
export class DataProviderLogPlanViewComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<DataProviderLogPlanViewComponent>,
    public coreEnumService: CoreEnumService,
    public DataProviderLogPlanService: DataProviderLogPlanService,
  ...
  dataModelResult: ErrorExceptionResult<DataProviderLogPlanModel> =
    new ErrorExceptionResult<DataProviderLogPlanModel>();
  ...
  DataGetOneContent(): void {
    ...
    /*َAccess Field*/
    this.DataProviderLogPlanService.setAccessLoad();

    this.DataProviderLogPlanService.ServiceGetOneById(this.requestId).subscribe(
      {
        next: (ret) => {
          /*َAccess Field*/
