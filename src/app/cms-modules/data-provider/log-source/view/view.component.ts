...
export class DataProviderLogSourceViewComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<DataProviderLogSourceViewComponent>,
  ...
  dataModelResult: ErrorExceptionResult<DataProviderLogSourceModel> =
    new ErrorExceptionResult<DataProviderLogSourceModel>();
  dataModel: DataProviderLogSourceModel = new DataProviderLogSourceModel();
  ...
  DataGetOneContent(): void {
    ...
    /*َAccess Field*/
    this.DataProviderLogSourceService.setAccessLoad();

    this.DataProviderLogSourceService.ServiceGetOneById(
      this.requestId,
    ).subscribe({
      next: (ret) => {
        /*َAccess Field*/
