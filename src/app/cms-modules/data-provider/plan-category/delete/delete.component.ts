...
export class DataProviderPlanCategoryDeleteComponent implements OnInit {
  ...
  dataModelResultCategory: ErrorExceptionResult<DataProviderPlanCategoryModel> = new ErrorExceptionResult<DataProviderPlanCategoryModel>();
  dataModelResultCategoryAllData: ErrorExceptionResult<DataProviderPlanCategoryModel> = new ErrorExceptionResult<DataProviderPlanCategoryModel>();
  dataModel: any = {};
