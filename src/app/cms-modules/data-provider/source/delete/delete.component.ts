...
export class DataProviderSourceDeleteComponent implements OnInit {
  ...
  dataModelResultContent: ErrorExceptionResult<DataProviderSourceModel> =
  ...
  DataGetOne(): void {
    ...
    this.dataProviderSourceService.setAccessDataType(
  ...
  onFormDelete(): void {
    ...
    this.dataProviderSourceService.ServiceDelete(this.requestId).subscribe({
      next: (ret) => {
