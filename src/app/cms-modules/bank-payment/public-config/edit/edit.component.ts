...
import {BankPaymentPublicConfigAliasJsonModel,
...
export class BankPaymentPublicConfigEditComponent
  ...
  implements OnInit
{
  ...
  dataModel: BankPaymentPublicConfigAliasJsonModel =
    new BankPaymentPublicConfigAliasJsonModel();
  ...
  DataGetOneContent(): void {
    ...
    this.bankPaymentPublicConfigService.setAccessDataType(
