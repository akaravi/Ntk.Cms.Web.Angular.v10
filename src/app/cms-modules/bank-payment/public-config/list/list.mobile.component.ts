...
import { BankPaymentPublicConfigListComponent } from "./list.component";

@Component({
  selector: "app-bankpayment-publicconfig-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class BankPaymentPublicConfigListMobileComponent extends BankPaymentPublicConfigListComponent {
