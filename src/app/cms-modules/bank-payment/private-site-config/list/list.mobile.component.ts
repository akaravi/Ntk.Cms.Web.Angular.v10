...
import { BankPaymentPrivateSiteConfigListComponent } from "./list.component";

@Component({
  selector: "app-bankpayment-privateconfig-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class BankPaymentPrivateSiteConfigListMobileComponent extends BankPaymentPrivateSiteConfigListComponent {
