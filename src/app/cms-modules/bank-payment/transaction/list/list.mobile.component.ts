...
import { BankPaymentTransactionListComponent } from "./list.component";

@Component({
  selector: "app-bankpayment-transaction-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class BankPaymentTransactionListMobileComponent extends BankPaymentTransactionListComponent {
