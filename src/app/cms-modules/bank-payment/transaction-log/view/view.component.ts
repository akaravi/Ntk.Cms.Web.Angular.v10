...
import {
  BankPaymentTransactionLogModel, BankPaymentTransactionLogService, CoreEnumService, DataFieldInfoModel, ErrorExceptionResult,
...
export class BankPaymentTransactionLogViewComponent implements OnInit, OnDestroy {
  ...
  dataModel: BankPaymentTransactionLogModel = new BankPaymentTransactionLogModel();
