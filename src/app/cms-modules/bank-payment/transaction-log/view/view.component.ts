...
import {BankPaymentTransactionLogModel,
...
export class BankPaymentTransactionLogViewComponent
  implements OnInit, OnDestroy
{
  ...
  dataModelResult: ErrorExceptionResult<BankPaymentTransactionLogModel> =
    new ErrorExceptionResult<BankPaymentTransactionLogModel>();
  dataModel: BankPaymentTransactionLogModel =
  ...
  DataGetOneContent(): void {
    ...
    this.bankPaymentTransactionLogService
