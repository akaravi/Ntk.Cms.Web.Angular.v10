...
import { BankPaymentTransactionLogListComponent } from "./list.component";

@Component({
  selector: "app-bankpayment-transactionlog-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class BankPaymentTransactionLogListMobileComponent extends BankPaymentTransactionLogListComponent {
