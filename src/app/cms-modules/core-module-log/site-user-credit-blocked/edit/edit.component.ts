...
import {
  CoreEnumService, CoreModuleLogSiteUserCreditBlockedModel, CoreModuleLogSiteUserCreditBlockedService,
...
export class CoreModuleLogSiteUserCreditBlockedEditComponent extends EditBaseComponent<CoreModuleLogSiteUserCreditBlockedService, CoreModuleLogSiteUserCreditBlockedModel, string>
  ...
  constructor(
    ...
    super(coreModuleLogSiteUserCreditBlockedService, new CoreModuleLogSiteUserCreditBlockedModel(), publicHelper, translate);
