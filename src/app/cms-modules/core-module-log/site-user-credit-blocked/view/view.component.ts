...
export class CoreModuleLogSiteUserCreditBlockedViewComponent
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<CoreModuleLogSiteUserCreditBlockedViewComponent>,
  ...
  dataModelResult: ErrorExceptionResult<CoreModuleLogSiteUserCreditBlockedModel> =
    new ErrorExceptionResult<CoreModuleLogSiteUserCreditBlockedModel>();
  dataModel: CoreModuleLogSiteUserCreditBlockedModel =
    new CoreModuleLogSiteUserCreditBlockedModel();
  ...
  DataGetOneContent(): void {
    ...
    this.coreModuleLogSiteUserCreditBlockedService
