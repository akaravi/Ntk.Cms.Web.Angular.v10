...
import { CoreModuleLogFavoriteListComponent } from "./list.component";

@Component({
  selector: "app-coremodulelog-favorite-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class CoreModuleLogFavoriteListMobileComponent extends CoreModuleLogFavoriteListComponent {
