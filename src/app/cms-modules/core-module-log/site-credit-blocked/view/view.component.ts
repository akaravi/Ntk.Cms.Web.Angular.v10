...
@Component({
  selector: "app-coremodulelog-site-credit-blocked-view",
  templateUrl: "./view.component.html",
  standalone: false,
})
export class CoreModuleLogSiteCreditBlockedViewComponent
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<CoreModuleLogSiteCreditBlockedViewComponent>,
  ...
  dataModelResult: ErrorExceptionResult<CoreModuleLogSiteCreditBlockedModel> =
    new ErrorExceptionResult<CoreModuleLogSiteCreditBlockedModel>();
  dataModel: CoreModuleLogSiteCreditBlockedModel =
  ...
  DataGetOneContent(): void {
    ...
    this.coreModuleLogSiteCreditBlockedService
