...
import {
  CoreEnumService, CoreModuleLogSiteCreditBlockedModel, CoreModuleLogSiteCreditBlockedService, CoreSiteModel,
...
export class CoreModuleLogSiteCreditBlockedListComponent extends ListBaseComponent<CoreModuleLogSiteCreditBlockedService, CoreModuleLogSiteCreditBlockedModel, string>
  ...
  constructor(
    ...
    super(contentService, new CoreModuleLogSiteCreditBlockedModel(), publicHelper, tokenHelper, translate);
