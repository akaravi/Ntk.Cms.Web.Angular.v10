...
export class CoreModuleLogScoreEditComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  dataModelResult: ErrorExceptionResult<CoreModuleLogScoreModel> =
    new ErrorExceptionResult<CoreModuleLogScoreModel>();
  ...
  DataGetOneContent(): void {
    ...
    this.coreModuleLogScoreService.setAccessDataType(
