...
import { CoreModuleLogScoreListComponent } from "./list.component";

@Component({
  selector: "app-coremodulelog-score-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class CoreModuleLogScoreListMobileComponent extends CoreModuleLogScoreListComponent {
