...
import { CoreModuleLogSiteCreditListComponent } from "./list.component";

@Component({
  selector: "app-coremodulelog-site-credit-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class CoreModuleLogSiteCreditListMobileComponent extends CoreModuleLogSiteCreditListComponent {
