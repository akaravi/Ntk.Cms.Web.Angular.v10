...
import {
  CoreEnumService, CoreModuleLogSiteCreditModel, CoreModuleLogSiteCreditService, CoreSiteModel,
...
export class CoreModuleLogSiteCreditListComponent extends ListBaseComponent<CoreModuleLogSiteCreditService, CoreModuleLogSiteCreditModel, string>
  ...
  constructor(
    ...
    super(contentService, new CoreModuleLogSiteCreditModel(), publicHelper, tokenHelper, translate);
