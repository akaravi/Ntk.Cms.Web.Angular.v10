...
import { CoreModuleLogLikeListComponent } from "./list.component";

@Component({
  selector: "app-coremodulelog-like-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class CoreModuleLogLikeListMobileComponent extends CoreModuleLogLikeListComponent {
