...
export class CoreModuleLogSiteUserCreditEditComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    super(
      coreModuleLogSiteUserCreditService,
      new CoreModuleLogSiteUserCreditModel(),
      publicHelper,
      translate,
    );
  ...
  dataModelResult: ErrorExceptionResult<CoreModuleLogSiteUserCreditModel> =
    new ErrorExceptionResult<CoreModuleLogSiteUserCreditModel>();
  dataModel: CoreModuleLogSiteUserCreditModel =
    new CoreModuleLogSiteUserCreditModel();
  ...
  DataGetOneContent(): void {
    ...
    this.coreModuleLogSiteUserCreditService.setAccessDataType(
      ManageUserAccessDataTypesEnum.Editor,
    );
    this.coreModuleLogSiteUserCreditService
