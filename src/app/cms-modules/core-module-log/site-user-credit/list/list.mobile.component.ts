...
import { CoreModuleLogSiteUserCreditListComponent } from "./list.component";

@Component({
  selector: "app-coremodulelog-site-user-credit-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class CoreModuleLogSiteUserCreditListMobileComponent extends CoreModuleLogSiteUserCreditListComponent {
