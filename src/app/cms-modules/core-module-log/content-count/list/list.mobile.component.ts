...
import { CoreModuleLogContentCountListComponent } from "./list.component";

@Component({
  selector: "app-coremodulelog-content-count-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class CoreModuleLogContentCountListMobileComponent extends CoreModuleLogContentCountListComponent {
