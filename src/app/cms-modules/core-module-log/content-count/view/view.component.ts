...
import {CoreEnumService,
  CoreModuleLogContentCountModel,
...
@Component({
  selector: "app-coremodulelog-content-count-view",
  templateUrl: "./view.component.html",
  standalone: false,
})
export class CoreModuleLogContentCountViewComponent
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<CoreModuleLogContentCountViewComponent>,
  ...
  dataModelResult: ErrorExceptionResult<CoreModuleLogContentCountModel> =
    new ErrorExceptionResult<CoreModuleLogContentCountModel>();
  dataModel: CoreModuleLogContentCountModel =
    new CoreModuleLogContentCountModel();
  ...
  DataGetOneContent(): void {
    ...
    this.coreModuleLogContentCountService
