...
import { CoreModuleLogReportAbuseListComponent } from "./list.component";

@Component({
  selector: "app-coremodulelog-report-abuse-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class CoreModuleLogReportAbuseListMobileComponent extends CoreModuleLogReportAbuseListComponent {
