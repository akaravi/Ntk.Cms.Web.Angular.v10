...
export class CoreModuleLogReportAbuseViewComponent
  implements OnInit, OnDestroy
{
  ...
  dataModelResult: ErrorExceptionResult<CoreModuleLogReportAbuseModel> =
    new ErrorExceptionResult<CoreModuleLogReportAbuseModel>();
  dataModel: CoreModuleLogReportAbuseModel =
    new CoreModuleLogReportAbuseModel();
  ...
  DataGetOneContent(): void {
    ...
    this.coreModuleLogReportAbuseService.setAccessDataType(
      ManageUserAccessDataTypesEnum.Editor,
    );
    this.coreModuleLogReportAbuseService
