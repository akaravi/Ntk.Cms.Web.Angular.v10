...
import { CoreModuleLogShowKeyListComponent } from "./list.component";

@Component({
  selector: "app-coremodulelog-show-key-list-mobile",
  templateUrl: "./list.mobile.component.html",
  standalone: false,
})
export class CoreModuleLogShowKeyListMobileComponent extends CoreModuleLogShowKeyListComponent {
