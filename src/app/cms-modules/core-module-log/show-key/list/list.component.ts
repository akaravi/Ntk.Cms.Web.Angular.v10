...
import {
  CoreEnumService, CoreModuleLogShowKeyModel, CoreModuleLogShowKeyService, CoreSiteModel,
...
export class CoreModuleLogShowKeyListComponent extends ListBaseComponent<CoreModuleLogShowKeyService, CoreModuleLogShowKeyModel, string>
  ...
  constructor(
    ...
    super(contentService, new CoreModuleLogShowKeyModel(), publicHelper, tokenHelper, translate);
