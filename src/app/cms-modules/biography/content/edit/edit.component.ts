...
export class BiographyContentEditComponent
  ...
  implements OnInit
{
  ...
  dataContentTagModelResult: ErrorExceptionResult<BiographyContentTagModel> =
    new ErrorExceptionResult<BiographyContentTagModel>();
