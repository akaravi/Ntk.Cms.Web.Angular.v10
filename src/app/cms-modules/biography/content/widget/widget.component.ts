...
export class BiographyContentWidgetComponent implements OnInit, OnDestroy {
  ...
  onActionStatist(): void {
    this.translate.get('MESSAGE.Get_active_biography_statistics').subscribe((str: string) => {
      this.publicHelper.processService.processStart(this.constructor.name + 'Active', str, this.constructorInfoAreaId);
    });
    this.translate.get('MESSAGE.Get_statistics_on_all_biography').subscribe((str: string) => {
