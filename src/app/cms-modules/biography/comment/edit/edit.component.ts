...
import {
  BiographyCommentModel, BiographyCommentService, CoreEnumService,
...
export class BiographyCommentEditComponent extends EditBaseComponent<BiographyCommentService, BiographyCommentModel, number>
  implements OnInit {
  requestId = 0;
  requestParentId = 0;
  requestContentId = 0;
