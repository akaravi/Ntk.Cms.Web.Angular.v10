...
export class BiographyCategoryTreeSelectorComponent
  implements OnInit, OnDestroy
{
  ...
  checklistSelection = new SelectionModel<BiographyCategoryModel>(
    true /* multiple */,
  );
  hasChild = (_: number, node: BiographyCategoryModel) =>
    !!node.children && node.children.length > 0;
  childrenAccessor = (node: BiographyCategoryModel) => node.children ?? [];
  hasNoContent = (_: number, nodeData: BiographyCategoryModel) =>
    nodeData.children;
