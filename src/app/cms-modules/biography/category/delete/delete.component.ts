...
export class BiographyCategoryDeleteComponent implements OnInit {
  ...
  dataModelResultCategory: ErrorExceptionResult<BiographyCategoryModel> =
    new ErrorExceptionResult<BiographyCategoryModel>();
  dataModelResultCategoryAllData: ErrorExceptionResult<BiographyCategoryModel> =
    new ErrorExceptionResult<BiographyCategoryModel>();
  dataModel: any = {};
  ...
  DataGetAll(): void {
    ...
    this.biographyCategoryService.ServiceGetAll(filterModel).subscribe({
      next: (ret) => {
  ...
  onFormDelete(): void {
    ...
    this.biographyCategoryService.ServiceDelete(this.requestId).subscribe({
      next: (ret) => {
