...
export class MemberGroupListComponent
  extends ListBaseComponent<MemberGroupService, MemberGroupModel, number>
  implements OnInit, OnDestroy
{
  ...
  onActionButtonDeleteRow(
    ...
    const dialogRef = this.dialog.open(MemberGroupDeleteComponent, {
      height: "90%",
