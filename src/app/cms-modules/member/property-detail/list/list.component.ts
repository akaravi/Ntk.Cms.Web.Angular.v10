...
import {
  ...
  MemberPropertyDetailService, MemberPropertyTypeModel, MemberPropertyTypeService, RecordStatusEnum, SortTypeEnum
} from 'ntk-cms-api';
...
export class MemberPropertyDetailListComponent extends ListBaseComponent<MemberPropertyDetailService, MemberPropertyDetailModel, number> implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    super(contentService, new MemberPropertyDetailModel(), publicHelper, tokenHelper, translate);
