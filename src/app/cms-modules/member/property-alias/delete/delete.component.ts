...
import {DataFieldInfoModel,
  ...
  MemberPropertyAliasService} from "ntk-cms-api";
import { PublicHelper } from "src/app/core/helpers/publicHelper";
import { CmsToastrService } from "src/app/core/services/cmsToastr.service";
@Component({
  selector: "app-member-propertyalias-delete",
  templateUrl: "./delete.component.html",
  standalone: false,
})
export class MemberPropertyAliasDeleteComponent implements OnInit {
  requestId = 0;
  constructorInfoAreaId = this.constructor.name;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private dialogRef: MatDialogRef<MemberPropertyAliasDeleteComponent>,
  ...
  dataModelResultContent: ErrorExceptionResult<MemberPropertyAliasModel> =
