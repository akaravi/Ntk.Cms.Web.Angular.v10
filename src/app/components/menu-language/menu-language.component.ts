...
export class MenuLanguageComponent implements OnInit {
  ...
  actionSetLanguage(lang: string): void {
    ...
    this.cmsStoreService.getStateAll.themeStore.themeLanguage = this.cmsTranslationService.setLanguage(lang);
    if (this.cmsStoreService.getStateAll.themeStore.themeLanguage === 'fa' || this.cmsStoreService.getStateAll.themeStore.themeLanguage === 'ar')
