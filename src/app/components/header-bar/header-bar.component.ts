...
export class HeaderBarComponent implements OnInit {
  ...
  get rootClass() {
    if (this.themeStore.themeDirection === "ltr") return "theme-direction-rtl";
    else return "theme-direction-ltr";
  }
  get leftToRightClass() {
    if (this.themeStore.themeDirection === "ltr") return "left";
    else return "right";
  }
  get rightToleftClass() {
    if (this.themeStore.themeDirection === "ltr") return "right";
    else return "left";
  }
  ...
  onActionButtonShowKey(): void {
    if (!this.contentInfo || this.contentInfo.id?.length == 0) return;
    //open popup
